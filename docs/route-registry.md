...
| `/app/biological/compare` | MOD-12 | Implemented locally in P14; deploy/recheck staging pending | `/api/v1/organizations/{id}/biological/comparisons` and child validate/detail/chart/clone/export routes | P14 |
