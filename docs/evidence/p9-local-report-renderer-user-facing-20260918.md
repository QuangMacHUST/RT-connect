...
Lát cắt này chưa đính kèm ảnh phân tích thật vào PDF/PNG, chưa dựng bảng nhiều trang, chưa kiểm tra hiển thị trực quan trên trình duyệt và chưa chạy phiên có đăng nhập trên staging. Vì vậy P09-W02/P09-W03 và toàn bộ P9 vẫn mở; không được dùng bằng chứng này để tuyên bố sẵn sàng lâm sàng.
