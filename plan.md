...
- [ ] P09-W03 — Renderer dùng ảnh+overlays thật từ kết quả Pylinac, font tiếng Việt, bảng qua trang, preview cùng engine; lát cắt font, nội dung ghi chú, chia PDF nhiều trang và nhúng lớp phủ ảnh vào PDF đã đạt cục bộ theo [bằng chứng renderer báo cáo](docs/evidence/p9-local-report-renderer-user-facing-20260918.md), còn thiếu ảnh PNG, bảng nghiệp vụ nhiều trang, preview cùng engine và kiểm chứng staging.
