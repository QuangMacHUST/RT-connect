...
- [ ] P05-VERIFY — Chạy các TC-UX1 dưới đây và nhóm lỗi dùng chung có liên quan; lưu actual/evidence theo SHA. Lát cắt xóa hồ sơ không liên kết và lỗi mạng cho đường đọc trên staging đã PASS; trường hợp hồ sơ có liên kết khi thao tác thật, tiến trình nền khi chạy một lượt phân tích và toàn vẹn dữ liệu sau toàn bộ vòng đời vẫn mở.
- [ ] P05-HANDOFF — Cập nhật tiến độ, dữ liệu/migration/tuyến bị tác động, giới hạn hỗ trợ và bước tiếp theo.

**Cập nhật cổng staging:** lỗi mạng đã đạt cho lát cắt đọc; các trường hợp từ chối dữ liệu có liên kết khi thao tác thật, tiến trình nền khi thao tác thật và toàn vẹn dữ liệu sau toàn bộ vòng đời vẫn mở.
