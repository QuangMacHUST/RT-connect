...
**Trạng thái hiện tại:** `ACTIVE_AFTER_P06_HANDOFF`; P6 đã hoàn tất VERIFY/HANDOFF ở source `6615820`, P7 tiếp tục bằng W01/W02/W03. Đã có lát cắt local thực thi thật cho P07-PF, P07-WL, P07-STAR, P07-WLMT, ba biến thể P07-VMAT (DRGS/DRMLC/DRCS), P07-FPA và P07-FA bằng wheel đã khóa. P07-CAL và P07-LOG đã có adapter, giao diện và hợp đồng; Dynalog cùng Trajectory Log 2.1 đã chạy được dữ liệu mẫu thật của Pylinac, còn Trajectory Log 3/4 mới ở mức kiểm tra tương thích hợp đồng. Năm lớp CatPhan, ba lớp ACR, hai lớp Cheese, GE Helios và hai lớp Quart đã có adapter/giao diện/hợp đồng nhưng chưa có fixture engine thật. P07-PLANAR đã xác nhận chạy engine thật và tạo ảnh minh họa cho Leeds TOR và Standard Imaging FC-2 bằng tệp mẫu chính thức; 17 biến thể ảnh phẳng còn lại vẫn cần fixture tương ứng. P07-NUCLEAR hiện đã có đủ chín adapter, biểu mẫu riêng, kiểm tra đầu vào DICOM, ánh xạ `results_data()` và ảnh minh họa khi lớp Pylinac cung cấp; riêng bài tốc độ đếm cực đại có thể trả cảnh báo nếu lỗi chỉ nằm ở ảnh minh họa nhưng vẫn giữ kết quả đo. Chín bài hạt nhân chưa có fixture DICOM chuẩn và chưa kiểm chứng staging. P07-CONTRIB hiện đã có hai adapter, hai biểu mẫu, kiểm tra đầu vào ảnh, lịch sử/đánh giá và ảnh minh họa; Quasar ánh xạ `results_data()`, còn Jaw ánh xạ phương thức công khai `results()` do đặc điểm riêng của lớp. Hai bài đóng góp chưa có fixture chuẩn và chưa kiểm chứng staging. Đây chưa phải nghiệm thu P7 vì còn ma trận fixture, khung kết quả dùng chung, các bài còn thiếu và VERIFY/HANDOFF.
...
- [ ] P07-CHEESE — TomoCheese và CIRS 062M; origin/ROI/reference density controls và density/HU outputs. Lát cắt hiện đã gọi đúng hai lớp Pylinac, nhận ZIP DICOM, điều chỉnh lát/tâm/góc/vùng, tùy chọn mật độ tham chiếu ROI và lưu kết quả/overlay/lịch sử; chưa có fixture Cheese để xác nhận các ROI và đường mật độ thật, chưa kiểm chứng staging.
