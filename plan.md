...
Evidence hiện tại: `docs/evidence/p4-local-organization-ui-20260913-8a1fe44.json`, `docs/evidence/p4-local-machine-creation-20260913.json`, `docs/evidence/p4-local-organization-api-20260913.json`, `docs/evidence/p4-local-qa-history-20260913.json`, `docs/evidence/p4-staging-verified-20260913-8a1fe44.json`, `docs/evidence/p4-staging-public-verifier-20260913-e8c4323.json`, `docs/evidence/p4-staging-public-verifier-20260913-9d95f89.json`, `docs/evidence/p4-staging-public-verifier-20260913-b53916c.json`, `docs/evidence/p4-staging-public-verifier-20260913-d329ab7.json`, `docs/evidence/p4-staging-invite-inbox-20260913-246d1e5.json`, `docs/evidence/p4-staging-invite-qa-readback-20260913-246d1e5.json`, `docs/evidence/p4-staging-machine-archive-restore-20260913-392f4d9.json` và `docs/evidence/p4-api-regression-docker-20260913-4d17189.json`. Bằng chứng mới nhất xác nhận bản sửa biểu mẫu, source parity, triển khai đồng bộ ba dịch vụ trên staging, hộp thư lời mời/nhận lời mời, quyền đọc lại cơ sở/máy/lịch sử QA, lát cắt vòng đời lưu trữ/khôi phục máy và hồi quy API đầy đủ `207/207`: máy bị loại khỏi bộ chọn bài mới, lịch sử/tệp cũ còn nguyên, máy xuất hiện lại sau khôi phục và mã nguồn không có lỗi hồi quy API. Các bằng chứng này chưa thay cho kiểm xung đột hai danh tính, mã mời sai/đã dùng, kiểm vòng đời bằng hai phiên độc lập hoặc bàn giao P4. Trình tự kiểm tra cuối được ghi tại [phiếu kiểm chứng hai tài khoản](docs/runbooks/p4-kiem-chung-hai-tai-khoan-staging.md).
