...
- [ ] P09-W03 — Renderer dùng ảnh+overlays thật, font tiếng Việt, bảng qua trang, preview cùng engine; lát cắt font và nội dung ghi chú đã đạt cục bộ theo [bằng chứng renderer báo cáo](docs/evidence/p9-local-report-renderer-user-facing-20260918.md), còn thiếu ảnh phân tích thật, bảng nhiều trang và kiểm chứng staging.
