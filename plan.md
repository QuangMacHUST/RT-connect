...
Evidence hiện tại: `docs/evidence/p4-local-organization-ui-20260913.json`, `docs/evidence/p4-staging-verified-20260913-2143255.json` và `docs/evidence/p4-staging-public-verifier-20260913-2143255.json`. Lát cắt này không thay cho kiểm xung đột hai danh tính, vòng đời lưu trữ/khôi phục hoặc bàn giao P4.
...
Chức năng đã được người dùng chấp nhận vẫn hoạt động, layout gọn và kiểm hồi quy scope/revision đạt.
