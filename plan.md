...
Evidence hiện tại: `docs/evidence/p4-local-organization-ui-20260913-8a1fe44.json`, `docs/evidence/p4-local-machine-creation-20260913.json`, `docs/evidence/p4-local-organization-api-20260913.json`, `docs/evidence/p4-local-qa-history-20260913.json`, `docs/evidence/p4-staging-verified-20260913-8a1fe44.json`, `docs/evidence/p4-staging-public-verifier-20260913-e8c4323.json`, `docs/evidence/p4-staging-public-verifier-20260913-9d95f89.json`, `docs/evidence/p4-staging-public-verifier-20260913-b53916c.json`, `docs/evidence/p4-staging-public-verifier-20260913-d329ab7.json`, `docs/evidence/p4-staging-invite-inbox-20260913-246d1e5.json`, `docs/evidence/p4-staging-invite-qa-readback-20260913-246d1e5.json`, `docs/evidence/p4-staging-machine-archive-restore-20260913-392f4d9.json`, `docs/evidence/p4-staging-two-session-readback-20260913-2250.json`, `docs/evidence/p4-api-regression-docker-20260913-4d17189.json` và `docs/evidence/p4-web-invite-fallback-20260913.json`. Bằng chứng mới nhất xác nhận hai phiên cùng đọc đơn vị/cơ sở/máy/lịch sử và cơ chế xung đột khi lưu cùng phiên bản: phiên A lưu trước, phiên B nhận lỗi xung đột và giữ nội dung nhập; tên máy đã khôi phục về giá trị ban đầu. Các bằng chứng trước vẫn xác nhận hộp thư lời mời, lát cắt vòng đời lưu trữ/khôi phục máy, hồi quy API `207/207` và hồi quy web `31/31`. Hộp thư mã mời dự phòng trên tài khoản chưa có đơn vị, mã mời sai/đã dùng và kiểm vòng đời lưu trữ trong phiên thứ hai vẫn chưa đủ bằng chứng; trình tự kiểm tra cuối được ghi tại [phiếu kiểm chứng hai tài khoản](docs/runbooks/p4-kiem-chung-hai-tai-khoan-staging.md).
...
- [ ] P04-VERIFY — Đã đạt lát cắt hai phiên về đọc chung và xung đột sửa đồng thời; còn S04 (mã mời trên tài khoản chưa có đơn vị), E05 trong hai phiên và các negative case lời mời trước khi đóng.
