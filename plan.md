...
- [ ] P07-CAL — Calibration: TG-51 photon/electron legacy/electron modern và TRS-398 photon/electron; form theo protocol, factors/dose; adapter hiện gọi trực tiếp constructor và các thuộc tính kết quả công khai của đúng lớp Pylinac, không cần tệp đầu vào, hỗ trợ nhiều lần đọc và lưu hệ số/liều cùng lịch sử/đánh giá. Năm bài đã mở ở trạng thái READY và có contract test; còn thiếu fixture số đo chuẩn cho từng lớp, đối chiếu độc lập kết quả và kiểm chứng staging. Ghi rõ Pylinac chưa nhận revision TRS-398 2024 nếu bản khóa chưa có.
