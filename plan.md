...
- [ ] P09-W03 — Renderer dùng ảnh+overlays thật từ kết quả Pylinac, font tiếng Việt, bảng qua trang, preview cùng engine; lát cắt font, nội dung ghi chú và chia PDF nhiều trang đã đạt cục bộ theo [bằng chứng renderer báo cáo](docs/evidence/p9-local-report-renderer-user-facing-20260918.md), còn thiếu lấy lớp phủ từ kho, ảnh phân tích thật, bảng nghiệp vụ nhiều trang và kiểm chứng staging.
