...
> Cập nhật candidate staging ngày 2026-09-11: API `4dd93fe1-7103-4f53-8f67-9b508328e33f`, web `c394f01e-43ad-4844-9333-aebb16e880c0` và worker `fb58047b-e511-43bf-9754-4fc33f5e3be6` đều `SUCCESS` trên source SHA `1984c04ccce438cf1eaed9008a247eea517ca103`. Public verifier đạt `15/15`, schema `20260909_0019`; web bundle đã chứa contract `DownloadResponse.filename` và source marker mới. Fixture RTDOSE tổng hợp `gamma-rtdose-v1-smoke.dcm` đã được upload một lần trước đó vào case staging `ed7ddbe5-811a-4463-a270-b0386f64644d` với `REFERENCE/DICOM`, manifest được tạo và validation `VALID` (0 lỗi, 0 cảnh báo). Read-only download sau deployment mới giữ đủ 898 bytes và SHA-256 khớp fixture; Edge vẫn giữ hậu tố `.crdownload`, nên final filename/header readback qua browser vẫn là `UNVERIFIED`. Đây là `STAGING_VERIFIED_SLICE`, không tự đóng P06-W04/P06-VERIFY hoặc các gate fault/retry, storage reconciliation, release và handoff. Evidence parity: `docs/evidence/p20-staging-public-parity-20260911-1984c04.json`; download: `docs/evidence/p06-staging-rtdose-download-20260911-1984c04.json`; upload cũ giữ nguyên: `docs/evidence/p06-staging-rtdose-upload-20260911.json`.
