...
- [ ] P07-LOG — Dynalog và Trajectory Log 2.1/3.0/4.0, `.bin`/`.txt` theo class; bắt buộc chọn đúng cặp A/B cho Dynalog, giữ nguyên tên tệp để Pylinac ghép cặp, kiểm phiên bản Trajectory trước khi phân tích, hiển thị Axis/MLC/beam-hold/fluence và chỉ tạo Gamma fluence khi người dùng nhập đủ dung sai liều và khoảng cách. Lát cắt local đã gọi Dynalog và Trajectory 2.1 bằng dữ liệu demo thật, tạo chỉ số và biểu đồ MLC; còn thiếu fixture thực tế cho Trajectory 3/4, kiểm độ ổn định Gamma log và staging.
