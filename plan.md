...
- [ ] P07-CAL — Calibration: TG-51 photon/electron legacy/electron modern và TRS-398 photon/electron; form theo protocol, factors/dose; adapter hiện gọi trực tiếp constructor và các thuộc tính kết quả công khai của đúng lớp Pylinac, không cần tệp đầu vào, hỗ trợ nhiều lần đọc và lưu hệ số/liều cùng lịch sử/đánh giá. Kiểm thử hồi quy local đã đưa cả năm bài qua engine thật bằng số đo tổng hợp, đạt 5/5 đường chạy đúng và 1/1 trường hợp thiếu PDD10 bị chặn tại biên nhập liệu; không tạo overlay vì các lớp hiệu chuẩn không có ảnh phân tích. Còn thiếu số đo chuẩn/commissioning cho từng lớp, đối chiếu độc lập kết quả, kiểm lỗi miền vật lý và kiểm chứng staging. Ghi rõ Pylinac chưa nhận revision TRS-398 2024 nếu bản khóa chưa có.
