...
- [ ] P09-W03 — Renderer dùng ảnh+overlays thật từ kết quả Pylinac, font tiếng Việt, bảng qua trang, preview cùng engine; lát cắt font, nội dung ghi chú, chia PDF nhiều trang, nhúng lớp phủ ảnh vào PDF/PNG và xem trước từ cùng renderer đã đạt cục bộ theo [bằng chứng renderer báo cáo](docs/evidence/p9-local-report-renderer-user-facing-20260918.md) và [bằng chứng xem trước cùng renderer](docs/evidence/p9-local-preview-renderer-20260918.md), parity triển khai PDF/PNG staging đạt theo [bằng chứng PDF/PNG trên staging](docs/evidence/p9-staging-pylinac-overlay-png-20260918.json), còn thiếu bảng nghiệp vụ nhiều trang, kiểm thử có đăng nhập và VERIFY/HANDOFF.
- [ ] P09-W04 — Export idempotency theo snapshot/layout/renderer và history tải lại, deletion propagation. Hợp đồng xuất lặp bốn định dạng, lịch sử theo bản sửa đổi, phân trang, nút lấy liên kết tải mới và bù trừ lỗi lưu đã đạt cục bộ theo [bằng chứng xuất lặp](docs/evidence/p9-local-export-idempotency-20260918.md); API/web/worker staging đã đạt parity exact-SHA 16/16 theo [bằng chứng lịch sử tệp trên staging](docs/evidence/p9-staging-export-history-20260918.json). Còn kiểm thử có đăng nhập trên staging và đối chiếu lịch sử/tải lại. Lan truyền xóa vĩnh viễn được giữ ngoài phạm vi theo quyết định sản phẩm hiện tại; hồ sơ QA dùng lưu trữ/khôi phục.
