...
Danh mục engine bắt buộc: [docs/pylinac-qa-catalog.md](docs/pylinac-qa-catalog.md) v1.3.
...
- [x] P00-W01 — Viết nghiệp vụ 1.3, đặc tả 2.3, kế hoạch 5.3; giữ đủ danh mục pylinac 1.3 và bổ sung thư viện hai phạm vi.
...
- [x] P00-VERIFY — Đạt 516 điều kiện cấu trúc, 15 phép thử bộ kiểm; 21 giai đoạn/263 tình huống được mô tả. Kiểm liên kết và giữ nội dung lịch sử; thiết kế có năm màn, phần chưa đồng bộ tệp xuất ghi riêng. Bằng chứng: docs/evidence/ux1-3-planning-contract-20260913.json.
...
**Trạng thái hiện tại:** `STAGING_VERIFIED_AND_HANDOFF_COMPLETE`; P4 đã được người dùng nghiệm thu trên staging, đủ điều kiện mở P5.

Evidence hiện tại: `docs/evidence/p4-local-organization-ui-20260913-8a1fe44.json`, `docs/evidence/p4-local-machine-creation-20260913.json`, `docs/evidence/p4-local-organization-api-20260913.json`, `docs/evidence/p4-local-qa-history-20260913.json`, `docs/evidence/p4-staging-verified-20260913-8a1fe44.json`, `docs/evidence/p4-staging-public-verifier-20260913-e8c4323.json`, `docs/evidence/p4-staging-public-verifier-20260913-9d95f89.json`, `docs/evidence/p4-staging-public-verifier-20260913-b53916c.json`, `docs/evidence/p4-staging-public-verifier-20260913-d329ab7.json`, `docs/evidence/p4-staging-invite-inbox-20260913-246d1e5.json`, `docs/evidence/p4-staging-invite-qa-readback-20260913-246d1e5.json`, `docs/evidence/p4-staging-machine-archive-restore-20260913-392f4d9.json`, `docs/evidence/p4-staging-two-session-readback-20260913-2250.json`, `docs/evidence/p4-staging-final-acceptance-20260913-2257.json`, `docs/evidence/p4-api-regression-docker-20260913-4d17189.json` và `docs/evidence/p4-web-invite-fallback-20260913.json`. Bằng chứng và xác nhận nghiệm thu mới nhất đóng các lát cắt đơn vị, thành viên ngang quyền, lời mời/mã mời, xung đột hai phiên và vòng đời lưu trữ/khôi phục máy trên staging. P4 đã được người dùng xác nhận hoàn thành; các phase sau vẫn phải tuân theo điều kiện tuần tự, không suy ra sẵn sàng lâm sàng từ nghiệm thu P4.
...
- [x] P04-W04 — Kiểm ngừng dùng/khôi phục máy, chuyển đơn vị và tác động tới bộ chọn máy/QA lịch sử. `STAGING_VERIFIED_SLICE`; trên staging, máy lưu trữ bị loại khỏi danh sách máy hoạt động, hai bài QA cũ và tệp RTDOSE vẫn đọc được, máy xuất hiện lại sau khôi phục. Evidence: `docs/evidence/p4-local-qa-history-20260913.json` và `docs/evidence/p4-staging-machine-archive-restore-20260913-392f4d9.json`. Kiểm hai phiên độc lập và chuyển đơn vị vẫn thuộc P04-VERIFY.
- [x] P04-W05 — Bổ sung hộp thư lời mời cho tài khoản chưa có đơn vị: tự tìm lời mời còn hạn theo email xác thực, tham gia theo lời mời đã chọn và vẫn hỗ trợ dán mã mời. `STAGING_VERIFIED_SLICE`; API tổ chức và giao diện đã có kiểm thử riêng; kiểm trực tiếp staging đạt P4-S03, tham gia đúng đơn vị và readback 2 thành viên. Evidence: `docs/evidence/p4-staging-invite-inbox-20260913-246d1e5.json`.
- [x] P04-VERIFY — Đã hoàn tất các kiểm tra staging còn mở theo xác nhận nghiệm thu trực tiếp của người dùng; bằng chứng tổng hợp tại `docs/evidence/p4-staging-final-acceptance-20260913-2257.json`.
- [x] P04-HANDOFF — Đã cập nhật tiến độ, runbook, bằng chứng, dữ liệu/migration/tuyến bị tác động và mở P5. P4 chỉ là nghiệm thu lát cắt staging; các phase QA, thư viện kiến thức, công cụ sinh học và phát hành còn lại vẫn mở.
...
**Trạng thái UX1 lúc lập kế hoạch:** yêu cầu mới; chưa được tính là hoàn thành từ evidence cũ.
**Trạng thái hiện tại:** `STAGING_VERIFIED_AND_HANDOFF_COMPLETE`; danh mục, lịch sử, hồ sơ cũ chưa phân loại và vòng lưu trữ/khôi phục đã được kiểm chứng trên staging ở bản `544a40c1a6ca6697f8b951002411ed97484ff59d`. Vòng kiểm tra hoàn tác bổ sung ngày 2026-09-14 đã lưu trữ rồi khôi phục lại hồ sơ tổng hợp có liên kết, xác nhận dữ liệu đầu vào vẫn còn; bằng chứng: `docs/evidence/p5-staging-reversible-lifecycle-20260914.json`. Ngày 2026-09-14 đã xóa vĩnh viễn thành công đúng một hồ sơ thử nghiệm tổng hợp mới tạo, không có tệp đầu vào và không có liên kết dữ liệu; bằng chứng: `docs/evidence/p5-staging-unreferenced-purge-20260914.json`. Với hồ sơ `dailyQA` có liên kết, người dùng đã xác nhận thao tác xóa; máy chủ trả về xem trước `can_purge=false`, giao diện từ chối thao tác, tải lại vẫn giữ hồ sơ trong thùng rác và còn nguyên 2 kết quả kiểm tra máy cùng 6 điểm xu hướng; bằng chứng: `docs/evidence/p5-staging-linked-case-purge-rejection-20260914.json`. Bản sửa phạm vi thùng rác đã triển khai và kiểm chứng trên staging: hồ sơ đang mở không còn lẫn trong danh sách đã lưu trữ; bằng chứng: `docs/evidence/p5-staging-trash-filter-20260914.json`. Bản web mới `75f86df` bổ sung chọn nhiều, đưa vào thùng rác, khôi phục và xóa vĩnh viễn nhiều mục; đã kiểm chứng cục bộ với báo cáo riêng từng mục và kiểm tra an toàn trên staging việc hiển thị/chọn/bỏ chọn; bằng chứng: `docs/evidence/p5-staging-batch-selection-20260914.json`. Kiểm tra giao diện chỉ đọc mới nhất xác nhận danh mục 63/63 bài, danh sách chính có hai hồ sơ đang mở và thùng rác chỉ có một hồ sơ đã lưu trữ, không lẫn hồ sơ đang mở; bằng chứng: `docs/evidence/p5-staging-trash-readonly-20260914.json`. Ngày 2026-09-14, kiểm tra chỉ đọc sau bản `cc02bf0` xác nhận cả ba dịch vụ staging đã chạy đúng bản phát hành, cấu hình Railway hiệu lực đạt toàn bộ kiểm tra và các tuyến công khai health/readiness/version/OpenAPI/web đều đạt; bằng chứng: `docs/evidence/p5-railway-effective-settings-20260914.json` và `docs/evidence/p5-staging-public-recheck-20260914-cc02bf0.json`. Kiểm tra parity ngay trước commit `f608f27` phát hiện API và web lệch nguồn do bộ lọc đường dẫn; bằng chứng lỗi: `docs/evidence/p5-staging-public-recheck-20260914-99d68f6.json`. Mốc theo dõi trong hai thư mục dịch vụ đã buộc Railway dựng lại toàn bộ ứng viên; lần kiểm tra exact-SHA sau đó đạt **16/16**, API/web/worker cùng bản `db97b0e` và lược đồ `20260913_0022`; bằng chứng: `docs/evidence/p5-staging-public-recheck-20260914-db97b0e.json`. Kiểm tra lại ứng viên `3701b65` sau đó cũng đạt **16/16**, xác nhận API/web/worker cùng commit và cùng lược đồ; bằng chứng: `docs/evidence/p5-staging-public-recheck-20260914-3701b65.json`. P5 đã đóng theo đúng chuỗi; thao tác ghi nhiều mục trên staging vẫn là ca riêng chưa nghiệm thu.
**Cập nhật trạng thái staging:** lỗi mạng, tiến trình nền Gamma thật và cổng bảo vệ hồ sơ có liên kết đã đạt. Không có dữ liệu liên quan bị mất; hồ sơ có liên kết chỉ bị chặn xóa, còn hồ sơ thử nghiệm không liên kết đã được xóa đúng phạm vi.

**Cập nhật VERIFY ngày 2026-09-14:** đã hoàn tất cổng tiến trình nền bằng thao tác thật trên hồ sơ `P6 Staging Upload Smoke`. Tệp đo 3D cũ bị forced revalidation từ chối vì thiếu `coordinate_frame`; sau khi tải lại fixture hợp lệ đúng loại/vai trò, preflight chuyển sang `VALID`, worker staging nhận job và lưu run Gamma 3D `COMPLETED/PASS`, 8/8 điểm, coverage 1, P95 0, attempt 1, engine `gamma-nd-p8.2`. Bằng chứng: `docs/evidence/p5-staging-gamma-worker-20260914.json`. Việc này không đóng các cổng độ tin cậy/hiệu năng và phát hành của P8. Hành trình xóa hồ sơ liên kết `dailyQA` cũng đã đạt: người dùng xác nhận thao tác, lớp xem trước staging phát hiện 2 kết quả kiểm tra máy và 6 điểm xu hướng, từ chối xóa; sau khi tải lại, hồ sơ và các liên kết vẫn còn. Bằng chứng: `docs/evidence/p5-staging-linked-case-purge-rejection-20260914.json`.
**Bằng chứng parity hiện hành 2026-09-14:** sau khi bộ kiểm tra triển khai được đẩy lên, Railway đã dựng lại API, web và worker cùng mã `517600d1f7a46597030af949bc3c3c46c3079a49`; kiểm tra công khai đạt **16/16**, lược đồ `20260913_0022`, health/readiness/version/OpenAPI và các tuyến bảo vệ truy cập đều đạt. Bằng chứng: `docs/evidence/p5-staging-public-recheck-20260914-517600d.json`. Đây là cổng parity, không đóng các cổng dữ liệu nghiệp vụ còn mở của P5.
...
Kiểm tra xem trước xóa chỉ đọc trên ứng viên `21b98ec` xác nhận hồ sơ `dailyQA` đã lưu trữ nhưng còn 2 kết quả kiểm tra máy và 6 điểm xu hướng liên quan nên bị chặn xóa vĩnh viễn; giao diện xác nhận hồ sơ và dữ liệu liên quan vẫn được giữ nguyên, không gửi yêu cầu xóa. Bằng chứng: `docs/evidence/p5-staging-linked-case-purge-preview-20260914.json`. Đây là kiểm chứng staging an toàn; cổng lỗi mạng đã đạt cho lát cắt đọc, còn tiến trình nền và toàn vẹn dữ liệu vẫn mở.
...
- [x] P05-W01 — Tạo danh mục có phiên bản và khóa bài; đã đưa đủ 64 mục từ sổ pylinac vào lớp dữ liệu, phân biệt bài nhập số đo, bài dùng hình ảnh, bài dùng liều và bài có điều khiển tay. Khóa bài chưa có bộ tích hợp để không tạo cảm giác đã sẵn sàng.
...
- [x] P05-W03 — Đã có lưu trữ có thể khôi phục, thùng rác, khôi phục và xóa vĩnh viễn có kiểm tra liên kết kết quả/tệp/báo cáo. Lát cắt staging đã kiểm chứng lưu trữ/khôi phục trên hồ sơ tổng hợp; đã xóa vĩnh viễn thành công một hồ sơ tổng hợp riêng không liên kết sau khi xác nhận đúng phạm vi. Hồ sơ có liên kết vẫn bị từ chối và được giữ nguyên. Bổ sung bước xem trước chỉ đọc để hiển thị cơ sở, máy, thời điểm và nhóm liên kết trước xác nhận; máy chủ vẫn kiểm tra lại khi xóa.
...
- [x] P05-VERIFY — Đã chạy các TC-UX1 dưới đây và nhóm lỗi dùng chung có liên quan; xóa hồ sơ không liên kết, lỗi mạng đường đọc, tiến trình nền Gamma thật và hồ sơ liên kết `dailyQA` đều có bằng chứng staging. `dailyQA` bị từ chối xóa với 2 kết quả kiểm tra máy và 6 điểm xu hướng; tải lại xác nhận toàn vẹn dữ liệu.
- [x] P05-HANDOFF — Đã cập nhật tiến độ, bằng chứng, giới hạn hỗ trợ, dữ liệu/migration/tuyến bị tác động và bước tiếp theo. P6 được mở theo đúng thứ tự; P5 chỉ nghiệm thu vòng danh mục/lịch sử/lưu trữ và bảo vệ dữ liệu, không tuyên bố toàn bộ 63 bộ tích hợp pylinac đã sẵn sàng.

**Cập nhật cổng staging:** lỗi mạng, tiến trình nền Gamma thật, xóa hồ sơ thử nghiệm không liên kết và từ chối hồ sơ có liên kết đã đạt; P5 chuyển sang P6. Các cổng tích hợp engine pylinac đầy đủ vẫn thuộc P7/P8.
...
Danh mục đúng đầu vào, dữ liệu cũ mở được, trash/restore/purge và liên kết lịch sử có test DB/worker/storage; hồ sơ không liên kết được xóa đúng phạm vi, hồ sơ liên kết bị chặn ở lớp xem trước và máy chủ vẫn có hàng rào `QA_CASE_REFERENCED`; không coi chỉ xóa hàng trên UI là đạt.

**Điều kiện đóng P5:** trường hợp staging hồ sơ có liên kết đã bị từ chối sau thao tác xác nhận và giữ nguyên khi tải lại; tiến trình nền Gamma thật đã đạt; đối chiếu xác nhận không mất tệp, kết quả, báo cáo hoặc xu hướng sau toàn bộ vòng đời. Lát cắt hồ sơ thử nghiệm không liên kết, lỗi mạng, danh mục, lịch sử, hồ sơ cũ và lưu trữ/khôi phục đều có bằng chứng staging. P5 đã bàn giao cho P6; không dùng kết quả này để suy ra P7/P8 đã hoàn thiện engine pylinac.
...
Input contract cho từng bài, fixture hợp lệ/lỗi và giới hạn tài nguyên đã thử; manifest không xuất hiện thô trong giao diện. Chỉ đóng P6 sau khi hàng đợi staging chứng minh được một mục lỗi không làm mất các mục thành công, thử lại đúng mục lỗi, kho lưu trữ không để lại vật mồ côi sau lỗi, tải xuống đối chiếu đúng byte/tên tệp và toàn bộ S/E/C có evidence theo source SHA.
...
**Trạng thái hiện tại:** `ACTIVE_AFTER_P06_HANDOFF`; P6 đã hoàn tất VERIFY/HANDOFF ở source `6615820`, P7 tiếp tục bằng W01/W02/W03. Đã có lát cắt local thực thi thật cho P07-PF, P07-WL, P07-STAR, P07-WLMT, ba biến thể P07-VMAT (DRGS/DRMLC/DRCS), P07-FPA và P07-FA bằng wheel đã khóa. P07-CAL và P07-LOG đã có adapter, giao diện và hợp đồng; Dynalog cùng Trajectory Log 2.1 đã chạy được dữ liệu mẫu thật của Pylinac, còn Trajectory Log 3/4 mới ở mức kiểm tra tương thích hợp đồng. Năm lớp CatPhan 503/504/600/604/700, một lớp Cheese TomoCheese, Quart DVT, nhãn Quart HyperSight qua bộ tính QuartDVT được Pylinac hỗ trợ và toàn bộ 19 biến thể ảnh phẳng đã chạy engine thật bằng tệp mẫu chính thức; các bài ACR, Cheese CIRS 062M và GE Helios vẫn cần fixture tương ứng. P07-NUCLEAR hiện đã có đủ chín adapter, biểu mẫu riêng, kiểm tra đầu vào DICOM, ánh xạ `results_data()` và ảnh minh họa khi lớp Pylinac cung cấp; kiểm thử hồi quy đã gọi thật đủ chín lớp bằng fixture tổng hợp không có dữ liệu bệnh nhân. P07-CONTRIB hiện đã có hai adapter, hai biểu mẫu, kiểm tra đầu vào ảnh, lịch sử/đánh giá và ảnh minh họa; kiểm thử hồi quy đã gọi thật cả Quasar và Jaw qua `execute_pylinac` bằng fixture tổng hợp. Riêng các tệp mẫu chuẩn/commissioning, đối chiếu từng chỉ số, kiểm lỗi đặc trưng và staging của các nhóm vẫn còn mở. Đây chưa phải nghiệm thu P7 vì còn ma trận fixture, khung kết quả dùng chung, các bài còn thiếu và VERIFY/HANDOFF.

 Bằng chứng lát cắt hiện hành: [P7 local Picket Fence và Starshot](docs/evidence/p7-local-picket-starshot-20260914.json), [P7 local Winston–Lutz](docs/evidence/p7-local-winston-lutz-20260914.json), [P7 local Winston–Lutz nhiều bi](docs/evidence/p7-local-winston-lutz-multi-target-20260914.json), [P7 local VMAT](docs/evidence/p7-local-vmat-20260914.json), [P7 local biên dạng trường](docs/evidence/p7-local-field-profile-20260914.json), [P7 ma trận tệp mẫu Pylinac](docs/evidence/p7-local-pylinac-demo-matrix-20260915.md), [P7 hợp đồng chín bài hạt nhân](docs/evidence/p7-local-nuclear-contract-20260915.json), [P7 hợp đồng hai bài đóng góp](docs/evidence/p7-local-contrib-contract-20260915.json) và các lát cắt Log Analyzer mới. Năm bằng chứng đầu xác nhận chín capability đã gọi Pylinac thật, lưu kết quả/overlay và vượt cổng local; ma trận tệp mẫu xác nhận thêm CatPhan 503/504/600/604, TomoCheese, Quart DVT, nhãn HyperSight qua bộ tính QuartDVT, toàn bộ 19 bài ảnh phẳng, Dynalog và Trajectory 2.1. Log Analyzer vẫn cần fixture/số đo chuẩn cho các biến thể còn lại; hiệu chuẩn vẫn cần fixture số đo. Lát cắt hạt nhân đã gọi thật đủ chín lớp bằng fixture tổng hợp và đạt kiểm thử hồi quy 1/1, nhưng chưa thay thế fixture DICOM chuẩn/commissioning, đối chiếu độc lập từng chỉ số và staging. Lát cắt đóng góp xác nhận hai lớp, hai cách lấy kết quả công khai và biểu mẫu tương ứng; chưa được coi là chạy engine thật cho đến khi có fixture ảnh chuẩn. CatPhan700, ACR, CIRS, Helios, Nuclear và Contrib vẫn cần ma trận fixture riêng, đối chiếu và staging; không cấp trạng thái hoàn thành cho các gói P7 còn lại.
...
3. Tiếp tục P07-PLANAR → P07-CT → P07-ACR → P07-CHEESE → P07-HELIOS → P07-QUART → P07-CAL → P07-LOG → P07-NUCLEAR → P07-CONTRIB; không bỏ biến thể còn công khai. P07-QUART đã xác nhận cả nhãn HyperSight bằng bộ tính QuartDVT tương thích của Pylinac; vẫn cần đối chiếu nhãn/ngữ nghĩa và staging. P07-NUCLEAR và P07-CONTRIB đã qua cổng adapter/biểu mẫu/hợp đồng local; công việc tiếp theo của hai nhóm là fixture chuẩn, đối chiếu trực tiếp từng lớp và staging.
...
4. Chạy tự động bằng đúng class pylinac; xem chỉ số, biểu đồ và overlay chuẩn hóa từ `results_data()`, thuộc tính kết quả công khai của nhóm hiệu chuẩn hoặc dữ liệu công khai Axis/MLC/Fluence của Log Analyzer.
...
**Cổng đầu vào Pylinac đã triển khai ở lát cắt local:** mọi tệp phải được kiểm tra và chuyển sang `VALID` trước khi gọi engine. ZIP chuỗi DICOM phải có thành viên DICOM đọc được; ảnh PNG/JPEG/TIFF hoặc DICOM ảnh phải có header/kích thước tối thiểu hợp lệ; nhật ký `.dlg`/`.bin`/`.tlog`/`.txt` phải không rỗng. CSV/PDF chưa có bộ kiểm tra nội dung nên không được đưa vào Pylinac khi chưa có hợp đồng riêng. Cổng này là điều kiện an toàn đầu vào, không thay thế fixture chuẩn, commissioning, đối chiếu độc lập hoặc kiểm chứng staging.
Sau khi triển khai commit `783f8b5`, kiểm tra exact-SHA trên staging đạt 16/16 và API/web cùng nhận lược đồ `20260914_0023`; đây chỉ là cổng parity, chưa phải chạy thật từng bài Pylinac. Bằng chứng: `docs/evidence/p7-staging-input-validation-gate-20260915.md`. Sau mốc giao diện, commit `ffad35305fa8a30d33ec052a793d85b0a28112d4` đã buộc API, giao diện và tiến trình nền dựng lại cùng nguồn; bộ xác minh công khai lại đạt 16/16. Kiểm chứng trình duyệt trên bài Kiểm tra sao xác nhận tệp hiện có hiển thị Hợp lệ và lịch sử rỗng; bằng chứng: `docs/evidence/p7-staging-input-validation-ui-20260915.md`.
**Cập nhật giao diện P7-W04:** các trang bài Pylinac tự kiểm tra tệp sau khi tải và có nút kiểm tra lại ngay cạnh tệp đã có. Trình phân tích chỉ được coi là sẵn sàng khi mọi tệp đang chọn có `data_status=VALID`; bài hiệu chuẩn không tệp không hiện bảng này. Vùng điều chỉnh đã có bộ chọn ảnh/lát cho DICOM nhiều khung và ZIP nhiều ảnh, tối đa 2.048 ảnh/lát; khi đổi tệp vùng chọn được tạo lại để không giữ nhầm tọa độ cũ. Cổng tệp hợp lệ áp dụng cho cả bài một tệp và bài nhiều tệp, còn tệp cảnh báo vẫn được giữ để kiểm tra lại. Đây là cổng UX local, cần kiểm chứng thao tác thật trên staging.
**Cập nhật cổng tương thích loại đầu vào 2026-09-16:** trạng thái `VALID` không còn được hiểu là phù hợp cho mọi bài. Các bài ảnh, chuỗi ảnh, chuỗi DICOM và bài hạt nhân loại RTDOSE, RTSTRUCT, RTPLAN và số đo trước khi gọi engine; giao diện dùng cùng quy tắc. Bằng chứng local: `docs/evidence/p7-local-input-profile-gate-20260916.md`. Cần kiểm tra exact-SHA trên staging và xác nhận lại danh sách đầu vào của bài Starshot.
**Đã kiểm tra staging 2026-09-16:** bản `02c51f3404a0c7ef509b752c96c0d1738b830db3` triển khai thành công cho API và giao diện; health/ready/version, cấu hình Railway và giao diện bài Kiểm tra sao đều đạt. Tệp RTDOSE hợp lệ hiện có không còn xuất hiện trong bộ chọn ảnh, vẫn còn nguyên ở khu vực tệp và lịch sử vẫn bằng `0`; không có dữ liệu nào bị tạo, sửa hoặc xóa. Bằng chứng: `docs/evidence/p7-staging-input-profile-gate-20260916.md`. Đây chỉ là cổng tương thích đầu vào trên staging, chưa đóng P7.
**Bổ sung cổng máy chủ 2026-09-16:** loại đầu vào `IMAGE_OR_PROFILE` của Phân tích biên dạng trường nay cũng được chặn độc lập ở API. Bản `3348524e5b98f1462f19450bfe3db9620f053cb1` triển khai thành công; kiểm tra công khai, toàn bộ kiểm thử API và bộ kiểm thử Pylinac đều đạt. Bằng chứng: `docs/evidence/p7-staging-image-or-profile-server-gate-20260916.md`. Không có lượt lịch sử hoặc dữ liệu hồ sơ nào bị tạo, sửa hoặc xóa.
**Đã kiểm tra exact-SHA staging 2026-09-16:** sau khi thêm mốc dựng lại dưới thư mục API và web, Railway đã phục vụ API và gói web từ cùng commit `905fbda295ca8554417382f8a292891f6c3df573`. Bộ xác minh công khai đạt `16/16`, API/web cùng phiên bản, readiness giữ lược đồ `20260914_0023`; không tạo, sửa, lưu trữ, khôi phục hoặc xóa dữ liệu `dailyQA`. Bằng chứng: `docs/evidence/p7-staging-validated-input-gate-20260916.json`. Đây là cổng phát hành và kiểm tra phiên bản, chưa thay thế chạy phân tích với tệp staging được phê duyệt hoặc nghiệm thu P7.
**Bổ sung hợp đồng registry 2026-09-16:** cổng máy chủ nay lấy hồ sơ đầu vào trực tiếp từ liên kết chạy thật của từng capability; registry đối chiếu `input_kind` với `input_profile` cho toàn bộ 63 capability và phải trả rỗng sai lệch trước khi phát hành. Bản `dee1b679f9ed349c11198c6a37e89c27b3a7921f` đã lên API/giao diện staging; kiểm tra công khai đạt, kiểm thử API toàn bộ đạt và hợp đồng kế hoạch đạt. Bằng chứng: `docs/evidence/p7-staging-runtime-input-profile-contract-20260916.md`. Không tạo, sửa, lưu trữ, khôi phục hoặc xóa hồ sơ `dailyQA`.
**Cập nhật P7-W04 2026-09-16:** khi chưa có ảnh phù hợp, vùng điều chỉnh hiển thị “Chọn ảnh để bật vùng điều chỉnh.”, không hiển thị trạng thái tải vô hạn; nút phân tích bị khóa và lịch sử không đổi. Kiểm thử riêng `3/3`, toàn bộ giao diện `51/51`, lint, kiểm tra kiểu và bản dựng đạt; staging đã xác nhận trực tiếp. Bằng chứng: `docs/evidence/p7-staging-empty-adjustment-state-20260916.md`. Đây là sửa trạng thái rỗng, chưa đóng toàn bộ P7-W04.
**Cập nhật P7-W04 2026-09-16:** lịch sử trên từng trang bài QA nay được lọc theo đúng bài đang mở, không lấy kết quả của bài khác trong cùng hồ sơ; kiểm thử tiện ích và toàn bộ giao diện đạt `54/54`, kiểm tra kiểu, lint và bản dựng đạt. Bằng chứng: `docs/evidence/p7-local-history-isolation-20260916.md`. Còn kiểm chứng staging, ROI chuyên biệt và ánh xạ tọa độ đa ảnh.
**Bổ sung P7-W03 2026-09-16:** thêm cổng đối chiếu 20 chỉ số lõi với giá trị tham chiếu của bộ mẫu chính thức Pylinac `3.47.0`, bao phủ thêm CatPhan 503/504/600/604, TomoCheese, Quart DVT và bốn bài ảnh phẳng; kiểm thử `-k core_metric` đạt `20/20`. Đây là kiểm tra ánh xạ với engine đã khóa, không phải oracle độc lập hoặc nghiệm thu lâm sàng. Bằng chứng: `docs/evidence/p7-local-official-core-metric-reference-20260916.md`. Các fixture đại diện/commissioning, oracle độc lập, staging toàn bộ nhóm và VERIFY/HANDOFF P7 vẫn mở.
**Quyết định phạm vi dữ liệu 2026-09-16:** bỏ qua công việc xóa vĩnh viễn hồ sơ; không tiếp tục xóa `dailyQA` hoặc dữ liệu liên kết. Các mô tả lịch sử về khả năng lưu trữ/khôi phục/xóa có kiểm soát được giữ lại để phản ánh chức năng đã tồn tại, nhưng không phải công việc đang thực hiện. Ưu tiên kế tiếp là gói P7/P8 còn mở và các phase chức năng tiếp theo.
**Cập nhật P7-WL 2026-09-16:** Winston–Lutz một bia nay hỗ trợ ba cách lấy góc: thông tin DICOM, tên tệp hoặc nhập theo thứ tự ảnh. Với nhập tay, giao diện tự tạo đủ dòng theo bộ ZIP, chỉ hiển thị số thứ tự ảnh; máy chủ ghép `axis_mapping` vào đúng thành viên ZIP trước khi gọi Pylinac và chặn thiếu góc/sai số dòng. Bản `eb0a87417d16364dd62a986efa62e9038bd54c86` đã được staging phục vụ; cổng công khai exact-SHA đạt 16/16, readiness dùng lược đồ `20260914_0023`. Bằng chứng: `docs/evidence/p7-staging-winston-lutz-manual-angle-deployment-20260916.json`. Đây là cổng parity triển khai, chưa phải chạy bài bằng tệp được phê duyệt hoặc nghiệm thu P7.
**Bổ sung P7-W04 2026-09-16:** phép chọn điểm trên vùng điều chỉnh được tách thành tiện ích ánh xạ theo kích thước ảnh gốc; điểm ngoài mép được giới hạn về biên hợp lệ, hỗ trợ tọa độ điểm ảnh và chuẩn hóa, có kiểm thử riêng `6/6` và toàn bộ giao diện `55/55`. Bằng chứng: `docs/evidence/p7-local-coordinate-clamp-20260916.md`. Đây là cổng an toàn tọa độ local, chưa đóng ROI chuyên biệt, ghép cặp theo từng ảnh hoặc kiểm chứng staging.
**Cập nhật parity staging 2026-09-15:** tuyến xem trước đầu vào đã được triển khai cùng API/web tại bản `7ed6ebf9b1064f4250efddf733446c1f5b8a9028`; kiểm tra công khai đạt 15/15, readiness `200/ready`, lược đồ `20260914_0023`, OpenAPI có tuyến xem trước và các tuyến tổ chức, các tuyến bảo vệ chưa xác thực trả `401`, gói web có dấu hiệu đúng bản phát hành. Bằng chứng: `docs/evidence/p7-staging-public-recheck-20260915-7ed6ebf-pass.json`. Đây chỉ là cổng parity triển khai; vẫn cần thao tác xác thực với tệp staging đại diện, kiểm tra canvas đa ảnh/ROI/chọn lát và VERIFY/HANDOFF P7.
**Cập nhật sau bộ chọn ảnh/lát 2026-09-15:** bản `68d2202504c344ac2830f6ce09fba53ea2f34b2a` đã lên đồng bộ API/web staging; kiểm tra công khai exact-SHA đạt 15/15 với health/readiness/version, lược đồ `20260914_0023`, OpenAPI, biên giới xác thực và gói web. Bằng chứng: `docs/evidence/p7-staging-public-recheck-20260915-68d2202.json`. Đây chỉ là cổng phát hành của tuyến xem trước; vẫn cần kiểm tra trình duyệt có đăng nhập với bộ tệp nhiều ảnh, đối chiếu tọa độ theo từng bài, ROI/chọn lát chuyên biệt và VERIFY/HANDOFF P7.
Kiểm tra trình duyệt staging cùng ngày đã xác nhận bài Kiểm tra sao hiển thị bộ chọn hai ảnh/lát (`#1`, `#2`) trên tệp DICOM nhiều khung ở trạng thái Hợp lệ; lịch sử không phát sinh kết quả vì chỉ kiểm tra giao diện. Bằng chứng: `docs/evidence/p7-staging-multi-image-preview-ui-20260915.json`. Đây chưa phải đối chiếu tọa độ theo từng lát hoặc nghiệm thu phép phân tích.
**Bổ sung P07-CAL 2026-09-16:** biểu mẫu hiệu chuẩn nay kiểm tra ngay trên giao diện các trường bắt buộc, số hữu hạn, miền tối thiểu và danh sách số đọc; giá trị có dấu phẩy sai hoặc để trống không còn bị âm thầm loại khỏi yêu cầu gửi lên máy chủ. Bài TRS-398 electron đã được sửa để hiển thị và gửi đúng hệ số `k_elec` thay vì `p_elec`; khi tạo yêu cầu, giao diện chỉ gửi hệ số phù hợp với quy trình và loại bỏ hệ số ẩn không được hỗ trợ. Tên năm bài hiệu chuẩn được hiển thị bằng nhãn nghiệp vụ tiếng Việt, lỗi hiện ở vùng cảnh báo lỗi riêng. Kiểm thử giao diện đạt `60/60`, kiểm tra kiểu, lint và bản dựng sản xuất đạt. Đây là cổng giao diện và ánh xạ tham số local; chưa đóng P07-CAL vì còn số đo chuẩn/commissioning, đối chiếu độc lập, kiểm lỗi miền vật lý và staging.
**Bổ sung P07-WL/WLMT 2026-09-16:** biểu mẫu Winston–Lutz và Winston–Lutz nhiều bi nay chặn ngay các giá trị trống, không phải số, mật độ điểm ảnh không hợp lệ, khoảng cách nguồn–ảnh không dương, kích thước bi hoặc bán kính trường không dương, cũng như cấu hình bi vượt giới hạn. Nhập góc theo thứ tự ảnh phải có đủ ba góc cho đúng số ảnh trước khi nút phân tích được bật. Máy chủ cũng chặn kích thước bi bằng 0 trước khi gọi Pylinac. Kiểm thử giao diện đạt `62/62`, kiểm thử máy chủ nhóm Pylinac đạt, kiểm tra kiểu, lint và bản dựng tiếp tục là cổng bắt buộc. Đây là cải tiến biên nhập liệu và bảo vệ hợp đồng; chưa đóng P07-WL/P07-WLMT vì còn fixture commissioning, đối chiếu độc lập, ánh xạ thao tác theo từng ảnh và kiểm chứng staging.
**Bổ sung P07-LOG 2026-09-16:** khi bật bản đồ Gamma fluence trong bài Dynalog hoặc Trajectory Log, giao diện nay bắt buộc dung sai liều và dung sai khoảng cách là số lớn hơn 0; khi không bật Gamma, hai trường này không được coi là bắt buộc. Lỗi được hiển thị ngay trên biểu mẫu và nút phân tích bị khóa. Kiểm thử riêng giao diện đạt `14/14`, kiểm tra kiểu, lint và bản dựng đạt; đây là cổng biên nhập liệu local, chưa đóng P07-LOG vì còn fixture Trajectory 3/4, kiểm tra Gamma log ổn định, fixture commissioning và kiểm chứng staging.
**Bổ sung P07-LOG 2026-09-16:** bộ chọn tệp nay kiểm tra đúng cấu trúc đầu vào trước khi gọi Pylinac: Dynalog phải có đúng một tệp DLG bắt đầu bằng A và một tệp DLG bắt đầu bằng B; Trajectory Log phải có đúng một tệp BIN/TLOG và chỉ được kèm một tệp TXT mô tả. API lặp lại cùng cổng kiểm tra để không phụ thuộc vào giao diện. Kiểm thử giao diện đạt `16/16`, kiểm thử nhóm Pylinac đạt `39/39`, kiểm tra kiểu, lint và bản dựng đạt. Đây vẫn là cổng hợp đồng local, chưa đóng P07-LOG vì còn fixture Trajectory 3/4, kiểm tra Gamma log ổn định, fixture commissioning và kiểm chứng staging.
**Kiểm tra staging P07-LOG 2026-09-16:** bản `43fc158bbac34c93127cf27a633881f620e67056` đã được Railway phục vụ cho cả API và giao diện. Bộ xác minh công khai đạt `16/16`; health/readiness 200, lược đồ `20260914_0023`, API/web cùng mã nguồn và gói giao diện có dấu hiệu cổng thành viên cùng các điều khiển QA. Đây chỉ là parity triển khai và kiểm tra biên chưa xác thực; chưa chạy Dynalog/Trajectory bằng bộ tệp staging được phê duyệt, nên P07-LOG vẫn mở.
**Bổ sung kiểm tra Gamma P07-LOG 2026-09-16:** hồi quy local gọi trực tiếp Dynalog chính thức `AQA.dlg/BQA.dlg` với Gamma fluence và dung sai liều/khoảng cách dương; Pylinac trả bản đồ `60 × 4000`, `240000` điểm hợp lệ, giá trị cực đại không nhỏ hơn trung bình và không âm. Đây là bằng chứng ổn định cho đường Gamma Dynalog của wheel `3.47.0`, không thay thế fixture Trajectory 3/4 hoặc commissioning.
**Bổ sung trình xem P07-WL 2026-09-16:** trình xem kết quả Winston–Lutz một bia nay đọc các nhóm kết quả theo từng ảnh từ snapshot Pylinac, trình bày góc máy, góc chuẩn trực, góc bàn, khoảng cách CAX–bi, véc-tơ CAX–bi và khoảng cách CAX–EPID. Khóa góc kỹ thuật của Pylinac được ẩn, chỉ giữ “Ảnh 1”, “Ảnh 2”…; kiểm thử giao diện riêng đạt `17/17`, kiểm tra kiểu và lint đạt. Đây là cải tiến trình bày kết quả, chưa thay thế đối chiếu độc lập, điều chỉnh ROI được Pylinac hỗ trợ hoặc kiểm chứng staging tương tác.
**Kiểm tra staging P07-WL 2026-09-16:** sau khi dựng lại API, worker và giao diện từ mốc `12650737b0b0c7a8de3f7773bfc2e5d27be4cab2`, bộ xác minh công khai đạt `16/16`; health/readiness 200, lược đồ `20260914_0023`, API/web cùng mã nguồn và gói web mới được phục vụ. Đây là parity triển khai và biên chưa xác thực, chưa phải chạy Winston–Lutz có đăng nhập bằng bộ ảnh được phê duyệt hoặc nghiệm thu P07-WL.
**Bổ sung trình xem P07-STAR 2026-09-16:** bài Kiểm tra sao nay có bảng kết quả đọc trực tiếp từ Pylinac gồm tâm vùng giao nhau, đường kính, bán kính, dung sai, kết luận của bộ tính và từng góc tia; tên khóa kỹ thuật, JSON, tên tệp và mã nội bộ không hiển thị. Kiểm thử giao diện toàn bộ đạt `67/67`, kiểm tra kiểu, lint và bản dựng đạt. Bản staging `63c480ea29e871b05f537a554fba1cdbd8b96296` đã được dựng lại cho API, worker và web; bộ xác minh công khai đạt `16/16`. Bằng chứng: `docs/evidence/p7-staging-starshot-result-viewer-20260916.json`. Đây chưa phải chạy bài bằng tệp commissioning có đăng nhập hoặc đóng P07-STAR.
**Bổ sung P07-VMAT 2026-09-16:** ba biểu mẫu DRGS, DRMLC và DRCS nay kiểm tra trước dung sai, chiều rộng/chiều dài đoạn phân tích và khoảng cách xuyên tâm DRCS; lỗi hiển thị ngay và nút phân tích bị khóa. Kiểm thử giao diện toàn bộ đạt `68/68`, kiểm tra kiểu, lint và bản dựng đạt. Bản staging `17a5f91bb0665a04d323dd49d55113975dbcd4e2` đã được dựng lại cho API, worker và web; bộ xác minh công khai đạt `16/16`. Bằng chứng: `docs/evidence/p7-staging-vmat-form-validation-20260916.json`. Đây chưa phải chạy ba bài VMAT bằng bộ tệp commissioning có đăng nhập hoặc đóng P07-VMAT.
**Bổ sung P07-CT 2026-09-16:** năm biểu mẫu CatPhan nay kiểm tra trước dung sai HU, ngưỡng CNR, dung sai độ dày, lát gốc, điều chỉnh hình học và hệ số kích thước vùng; lỗi hiển thị ngay và nút phân tích bị khóa. Kiểm thử giao diện toàn bộ đạt `69/69`, kiểm tra kiểu, lint và bản dựng đạt. Bản staging `f1bbd9b966895e65f9132813d75d3f0d91159a38` đã được dựng lại cho API, worker và web; bộ xác minh công khai đạt `16/16`. Bằng chứng: `docs/evidence/p7-staging-catphan-form-validation-20260916.json`. Đây chưa phải chạy CatPhan bằng fixture commissioning có đăng nhập hoặc đóng P07-CT.
**Bổ sung P07-ACR 2026-09-16:** ba biểu mẫu ACR CT 464, MRI lớn và MRI vừa nay kiểm tra trước lát gốc, điều chỉnh tâm/góc, hệ số kích thước vùng, hệ số thang đo và các trường riêng của MRI như số lần vọng, ngưỡng tương phản thấp và hệ số kiểm tra hợp lý. Lỗi hiển thị ngay bằng tiếng Việt và nút phân tích bị khóa trước khi tạo lượt chạy Pylinac; các trường MRI được bỏ qua khi người dùng chọn ACR CT. Kiểm thử giao diện toàn bộ đạt `70/70`, kiểm tra kiểu, lint và bản dựng sản phẩm đạt. Đây là cổng nhập liệu local; ACR vẫn chưa có fixture được phê duyệt trong môi trường hiện tại, chưa đối chiếu từng mô-đun, chưa kiểm chứng staging và chưa đóng P07-ACR.
**Kiểm tra staging P07-ACR 2026-09-18:** API, giao diện và tiến trình nền đã dựng thành công cùng commit `7df6c1857edb1aa8066cae6e69309f8ef91f323d`; bộ xác minh công khai exact-SHA đạt `16/16`, readiness `200`, lược đồ `20260914_0023`. Bằng chứng: `docs/evidence/p7-staging-acr-form-validation-20260918.json`. Đây chỉ là parity triển khai và kiểm tra biên công khai; chưa chạy ACR bằng bộ ảnh được phê duyệt, chưa đối chiếu kết quả từng mô-đun và chưa đóng P07-ACR.
**Bổ sung P07-CHEESE/P07-HELIOS/P07-QUART 2026-09-18:** các biểu mẫu phantom chuỗi DICOM nay kiểm tra trước lát gốc, điều chỉnh hình học, hệ số vùng và hệ số thang đo. Cheese kiểm tra mật độ tham chiếu ROI tùy chọn; Quart kiểm tra dung sai HU, thang đo, độ dày, ngưỡng CNR và dịch lát tìm góc; Helios không hiện các trường không thuộc hợp đồng của bài. Lỗi hiển thị ngay bằng tiếng Việt và nút phân tích bị khóa trước khi tạo lượt chạy Pylinac. Kiểm thử giao diện toàn bộ đạt `71/71`, kiểm tra kiểu, lint và bản dựng sản phẩm đạt. Đây là cổng nhập liệu local; các nhóm vẫn cần fixture được phê duyệt, đối chiếu mô-đun, kiểm chứng staging và nghiệm thu chuyên môn.
**Kiểm tra staging P07-CHEESE/P07-HELIOS/P07-QUART 2026-09-18:** API, giao diện và tiến trình nền đã dựng thành công cùng commit `71aaf91ce2c1ea6cf9b035eb403c1ff08fae5476`; bộ xác minh công khai exact-SHA đạt `16/16`, readiness `200`, lược đồ `20260914_0023`. Bằng chứng: `docs/evidence/p7-staging-ct-phantom-form-validation-20260918.json`. Đây chỉ là parity triển khai và kiểm tra biên công khai; chưa chạy bằng fixture phantom được phê duyệt, chưa đối chiếu từng mô-đun và chưa đóng các gói P07 tương ứng.
**Bổ sung P07-PLANAR 2026-09-18:** 19 bài ảnh phẳng dùng cổng nhập liệu chung để kiểm tra ngưỡng tương phản, điều chỉnh góc, hệ số vùng và thang đo. Tâm ngang/tâm dọc là tùy chọn nhưng nếu nhập thì phải nhập đủ cặp và là số hợp lệ; bài chụp tuyến vú không bị bắt buộc ngưỡng tương phản cao không áp dụng. Lỗi hiển thị ngay bằng tiếng Việt và nút phân tích bị khóa trước khi tạo lượt chạy Pylinac. Kiểm thử giao diện toàn bộ đạt `72/72`, kiểm tra kiểu, lint và bản dựng sản phẩm đạt. Đây là cổng nhập liệu local; còn fixture được phê duyệt, đối chiếu mô-đun và kiểm chứng staging.
**Kiểm tra staging P07-PLANAR 2026-09-18:** API, giao diện và tiến trình nền đã dựng thành công cùng commit `27958d95309eb3a0d9d408dcefa35d2f774b655e`; bộ xác minh công khai exact-SHA đạt `16/16`, readiness `200`, lược đồ `20260914_0023`. Bằng chứng: `docs/evidence/p7-staging-planar-form-validation-20260918.json`. Đây chỉ là parity triển khai và kiểm tra biên công khai; chưa chạy 19 bài bằng bộ ảnh được phê duyệt, chưa đối chiếu từng mô-đun và chưa đóng P07-PLANAR.
**Bổ sung P07-NUCLEAR 2026-09-18:** chín bài hạt nhân nay kiểm tra trước các tham số đặc thù: tỉ lệ vùng nhìn và ngưỡng trong khoảng hợp lệ, số khung nguyên và đúng thứ tự, bốn bề rộng vạch, sáu đường kính/góc cầu, cửa sổ tìm kiếm, hoạt độ và đồng vị. Lỗi hiển thị ngay bằng tiếng Việt và nút phân tích bị khóa trước khi gửi Pylinac. Kiểm thử giao diện toàn bộ đạt `73/73`, kiểm tra kiểu, lint và bản dựng sản phẩm đạt. Đây là cổng nhập liệu local; còn fixture chuẩn/commissioning, đối chiếu từng lớp và kiểm chứng staging.
**Kiểm tra staging P07-NUCLEAR 2026-09-18:** API, giao diện và tiến trình nền đã dựng thành công cùng commit `7ddedcbcaa072024118fbca4bc128658cb4e3a17`; bộ xác minh công khai exact-SHA đạt `16/16`, readiness `200`, lược đồ `20260914_0023`. Bằng chứng: `docs/evidence/p7-staging-nuclear-form-validation-20260918.json`. Đây chỉ là parity triển khai và kiểm tra biên công khai; chưa chạy chín bài bằng fixture DICOM được phê duyệt, chưa đối chiếu từng lớp và chưa đóng P07-NUCLEAR.
**Bổ sung P07-CONTRIB 2026-09-18:** bài Quasar Light/Rad Scaling nay kiểm tra phần trăm FWXM trong khoảng 1–100 và ngưỡng cạnh biên lớn hơn 0 trước khi gọi Pylinac; bài Jaw Orthogonality không bị áp thêm tham số không thuộc hợp đồng. Lỗi hiển thị ngay bằng tiếng Việt và nút phân tích bị khóa. Kiểm thử giao diện toàn bộ đạt `74/74`, kiểm tra kiểu, lint và bản dựng sản phẩm đạt. Đây là cổng nhập liệu local; còn fixture chuẩn/commissioning, đối chiếu chỉ số, kiểm lỗi ảnh không phù hợp và kiểm chứng staging.
**Kiểm tra staging P07-CONTRIB 2026-09-18:** API, giao diện và tiến trình nền đã dựng thành công cùng commit `8d3ee7d3ff83820447b0962de14f1e2270404f5c`; bộ xác minh công khai exact-SHA đạt `16/16`, readiness `200`, lược đồ `20260914_0023`. Bằng chứng: `docs/evidence/p7-staging-contrib-form-validation-20260918.json`. Đây chỉ là parity triển khai và kiểm tra biên công khai; chưa chạy hai bài bằng fixture ảnh được phê duyệt, chưa đối chiếu từng chỉ số và chưa đóng P07-CONTRIB.
**Hồi quy engine P7 2026-09-18:** tám nhóm kiểm thử Pylinac hiện có đã chạy bằng môi trường khóa, đạt `139/139`; không có lỗi, chỉ có bốn cảnh báo tương thích từ thư viện. Bằng chứng: `docs/evidence/p7-local-pylinac-regression-20260918.md`. Đây xác nhận không hồi quy trong adapter/registry và các đường chạy mẫu hiện có, không thay thế fixture commissioning hoặc đối chiếu độc lập.
**Bổ sung P7-W04 2026-09-18:** vùng xem trước của CatPhan, ACR, TomoCheese, CIRS 062M, GE Helios và Quart nay cho phép chọn hoặc kéo tâm phantom trực tiếp trên ảnh. Giao diện chỉ chuyển điểm được chọn so với tâm ảnh thành điều chỉnh ngang/dọc theo milimét; máy chủ trả riêng kích thước ảnh và thang đo điểm ảnh, không lộ thẻ DICOM, tên tệp, đường dẫn kho hoặc mã nội bộ. Khi ảnh không có thang đo vật lý, không suy diễn tọa độ mà hướng người dùng nhập điều chỉnh bằng ô số. Pylinac vẫn là engine duy nhất; RT-CONNECT chỉ đảm nhiệm thao tác giao diện, kiểm tra và truyền tham số.
Kiểm thử cổng này gồm kiểm tra ánh xạ tâm, giới hạn điểm ngoài mép, thiếu thang đo, hợp đồng thông tin xem trước, kiểm tra API artifact, toàn bộ giao diện `74/74`, kiểm tra kiểu, lint và bản dựng sản phẩm. Bằng chứng: `docs/evidence/p7-local-visual-phantom-center-adjustment-20260918.md`. Đây mới là lát cắt UX local; vẫn cần chạy với fixture phantom được phê duyệt, kiểm tra tương tác có đăng nhập trên staging, đối chiếu độc lập và nghiệm thu chuyên môn. Không tạo, sửa, lưu trữ, khôi phục hoặc xóa hồ sơ `dailyQA`.
**Kiểm tra parity staging P7-W04 2026-09-18:** API, giao diện và tiến trình nền đã dựng lại thành công cùng commit `b49aaf3363480c0c6468c7f53eb8038b86b31bda`; bộ xác minh công khai exact-SHA đạt `16/16`, health/readiness đều `200`, lược đồ `20260914_0023`, tuyến thông tin xem trước và gói giao diện đều hiện diện. Bằng chứng: `docs/evidence/p7-staging-visual-phantom-center-adjustment-20260918.json`. Đây chỉ là parity triển khai và kiểm tra biên không cần đăng nhập; chưa chạy thao tác chọn tâm bằng fixture phantom được phê duyệt và chưa đóng P7-W04. Không tạo, sửa, lưu trữ, khôi phục hoặc xóa hồ sơ `dailyQA`.

- [x] P07-W01 — QA nhập tay: bảng nhiều giá trị, checklist/NA, công thức có kiểu, chuẩn/ngưỡng trực quan và kết luận riêng; không yêu cầu DICOM khi bài không cần. Đã bổ sung ghi chú theo từng số đo, nhãn quy trình mẫu tiếng Việt và chặn số đo không thuộc quy trình khi đánh giá. Kiểm thử riêng đạt 9/9; bằng chứng: `docs/evidence/p7-local-manual-machine-qa-20260915.md`. Đây mới là lát cắt cục bộ, chưa đóng VERIFY/HANDOFF P7.
...
- [ ] P07-W03 — Phát triển `PylinacCapabilityRegistry` + `PylinacAdapter`; inventory wheel phải khớp registry đủ 16 họ chính, QA contrib công khai, class/variant, input profile, parameter schema, result mapping, overlay, error và fixture. Lát cắt local hiện đã có API, migration, lưu input/result/overlay và adapter thật cho Picket Fence, Winston–Lutz, Starshot, Winston–Lutz nhiều bi, ba lớp VMAT DRGS/DRMLC/DRCS, Field Profile Analysis, Field Analysis legacy, năm lớp hiệu chuẩn TG-51/TRS-398, bốn lớp Log Analyzer, chín lớp Nuclear và hai lớp Contrib. Dynalog và Trajectory Log 2.1 đã chạy dữ liệu mẫu thật; Trajectory Log 3/4 mới ở mức kiểm tra tương thích hợp đồng. CatPhan 503/504/600/604, TomoCheese, Quart DVT, nhãn HyperSight qua bộ tính QuartDVT tương thích và toàn bộ 19 biến thể ảnh phẳng đã chạy được tệp mẫu chính thức; chín lớp Nuclear đã chạy bằng fixture tổng hợp và kiểm thử hồi quy 1/1, nhưng CatPhan 700, ACR CT/MRI, CIRS 062M, GE Helios, tệp mẫu Nuclear chuẩn/commissioning và hai bài Contrib vẫn cần fixture đại diện. Bộ đối chiếu inventory động hiện đạt 61 đường dẫn biểu tượng công khai, 63 capability logic, không thiếu/không thừa/không có biểu tượng chưa gắn registry; bằng chứng: [inventory Pylinac](docs/evidence/p7-local-pylinac-inventory-20260915.json). Ma trận lỗi định dạng/tham số cục bộ đạt 16/16; bằng chứng: [ma trận lỗi Pylinac](docs/evidence/p7-local-pylinac-error-matrix-20260915.json). API đã bổ sung cổng bắt buộc `data_status=VALID`, chặn tệp chưa kiểm tra trước khi gọi engine và không tạo run; bằng chứng cục bộ được ghi trong tiến độ. Ma trận nền tệp mẫu chính thức đạt **36/36**; sau đó bổ sung bộ Winston–Lutz nhiều bi chính thức 19 ảnh/6 bi, nên ma trận hiện hành đạt **37/37** qua `execute_pylinac`; bằng chứng nền: [ma trận tệp mẫu tự động](docs/evidence/p7-local-pylinac-official-demo-matrix-20260915.json), phần bổ sung: [kiểm thử Winston–Lutz nhiều bi chính thức](docs/evidence/p7-local-winston-lutz-multi-target-official-demo-20260916.md). Ma trận fixture nội dung còn thiếu, đối chiếu kết quả, lỗi đặc trưng và staging của các nhóm vẫn mở, nên W03 chưa hoàn thành.
  - **Bổ sung ma trận bộ mẫu 2026-09-16:** registry nay khai báo bắt buộc trạng thái bộ mẫu cho đủ 63 capability: `OFFICIAL_DEMO` là 37, `SYNTHETIC_CONTRACT` là 13 và `COMMISSIONING_REQUIRED` là 13. Mỗi capability có tên tham chiếu và ghi chú giới hạn; kiểm thử chặn cả trạng thái thiếu hoặc thừa trong ma trận. Bằng chứng: `docs/evidence/p7-local-fixture-coverage-matrix-20260916.md`. Đây chỉ là cổng quản lý độ phủ và không biến mẫu tổng hợp thành bằng chứng commissioning.
  - **Bổ sung hiển thị độ phủ 2026-09-16:** API tổ chức trả trạng thái bộ mẫu, nhãn tham chiếu và ghi chú giới hạn cho từng capability; danh mục QA hiển thị nhãn tiếng Việt và tổng số theo ba nhóm. Toàn bộ bài vẫn được liệt kê và bài đã có giao diện vẫn có thể chọn; nhãn này chỉ giúp người dùng biết mức độ kiểm chứng, không tuyên bố nghiệm thu lâm sàng. Kiểm thử API registry `8/8`, giao diện `58/58`, kiểm tra kiểu, lint và bản dựng đạt; parity staging commit `226b5d2` đạt `16/16`. Bằng chứng: `docs/evidence/p7-staging-fixture-status-deployment-20260916.json`.
- [ ] P07-W04 — Xây result viewer/canvas chung: auto run, điều chỉnh bằng click/drag hoặc form, parameter diff, run mới, lớp ảnh/biểu đồ, cảnh báo của bộ tính, đánh giá và persist history. Hiện các lát cắt PF, Starshot, WL, WLMT, VMAT, FPA và FA có màn hình riêng với biểu mẫu, lịch sử, đánh giá và mở overlay; canvas dùng chung đã được mở rộng cho Picket Fence, Starshot, Field Profile/Field Analysis ở chế độ chọn vị trí thủ công và toàn bộ Planar Imaging ở chế độ chọn tâm phantom. Vùng chọn điểm hiện dùng tuyến xem trước có xác thực, dựng DICOM/ZIP thành PNG an toàn trong phạm vi tổ chức, có tuyến thông tin số ảnh/lát; chuỗi ngắn dùng danh sách, chuỗi dài dùng ô nhập số trong phạm vi tối đa 2.048 ảnh/lát nên không phụ thuộc vào trình duyệt tự hiển thị DICOM; Picket Fence có thể chọn hoặc nhập tâm trục trung tâm trước khi gọi Pylinac. Ảnh overlay hiện hiển thị ngay trong trang kết quả, có thể mở/ẩn và tự gắn với đúng lượt lịch sử đang xem. Cảnh báo từ Pylinac hiển thị trong vùng riêng, không tự đổi đánh giá và được giữ đúng theo lượt lịch sử; hồi quy cục bộ đạt 2/2, toàn bộ giao diện đạt 53/53. Tọa độ chuẩn hóa 0–1 và tọa độ điểm ảnh được chuyển đúng theo từng hợp đồng. **Cập nhật 2026-09-16:** trình xem Winston–Lutz nhiều bi đã có bảng đối chiếu theo từng ảnh và từng bi, lấy trực tiếp từ `image_details` của Pylinac; hiển thị góc, khoảng cách trường–bi và sai lệch xoay bàn, không hiển thị tên tệp kỹ thuật và hoạt động cả khi mở lại lượt cũ. Kiểm thử giao diện riêng đạt 8/8. Vẫn còn ROI chuyên biệt, ánh xạ tọa độ thao tác theo từng ảnh, lựa chọn ảnh ngoài giới hạn xem trước và kiểm chứng tương tác staging.
  - **Bổ sung UX 2026-09-16:** diff lịch sử đã đối chiếu hợp tham số của lượt hiện tại và lượt ngay trước, hiển thị rõ tham số mới thêm, thay đổi và đã bỏ bằng tiếng Việt. Kiểm thử giao diện đạt `52/52`, lint, kiểm tra kiểu và bản dựng đạt; bằng chứng local: `docs/evidence/p7-local-result-parameter-removal-20260916.md`. Còn mở kiểm tra parity staging, ROI chuyên biệt, ánh xạ tọa độ đa ảnh và lựa chọn ảnh ngoài giới hạn xem trước.
   - **Bổ sung UX 2026-09-16:** nút mở phân tích liều chỉ xuất hiện với bài có hợp đồng RTDOSE/PSQA; không còn bị bật bởi tệp RTDOSE/RTSTRUCT tình cờ nằm trong hồ sơ Starshot hoặc bài hình ảnh khác. Staging đã kiểm tra chỉ đọc với Starshot và PSQA, danh mục `64/64`; kiểm thử giao diện đạt `53/53`. Bằng chứng: `docs/evidence/p7-staging-dose-shortcut-contract-20260916.md`. Còn mở ROI chuyên biệt, ánh xạ tọa độ đa ảnh, lựa chọn ảnh ngoài giới hạn xem trước và nghiệm thu đầy đủ.
  - **Bổ sung UX 2026-09-16:** chuỗi DICOM/ZIP dài không còn bị giới hạn ở ảnh/lát thứ 32. Máy chủ cho phép tối đa 2.048 ảnh/lát trong vùng xem trước; giao diện dùng ô nhập số cho chuỗi dài và vẫn dùng danh sách cho chuỗi ngắn. Kiểm thử local với 33 ảnh DICOM tổng hợp đạt, toàn bộ máy chủ đạt 100%, giao diện đạt `53/53`. Bằng chứng: `docs/evidence/p7-local-long-series-preview-20260916.md`. Việc này xử lý giới hạn xem trước cũ; vẫn mở ROI chuyên biệt, ánh xạ tọa độ đa ảnh, kiểm chứng staging tương tác và nghiệm thu đầy đủ.
  - **Bổ sung cổng đầu vào 2026-09-16:** mọi bài Pylinac có tệp chỉ được phân tích khi các tệp đang chọn có trạng thái `VALID`; bài nhiều tệp kiểm tra toàn bộ danh sách, tệp cảnh báo vẫn có thể kiểm tra lại và bài hiệu chuẩn nhập số liệu không bị ảnh hưởng. Kiểm thử giao diện đạt `56/56`, kiểm tra kiểu, lint, bản dựng và hợp đồng kế hoạch đạt. Bằng chứng: `docs/evidence/p7-local-validated-input-gate-20260916.md`. Chưa đóng kiểm chứng staging toàn bộ bài, fixture chuẩn hoặc nghiệm thu lâm sàng.
   - **Cập nhật staging 2026-09-16:** bản `bef9777` đã lên cả máy chủ và giao diện; kiểm tra công khai chỉ đọc đạt `14/14`, health/readiness/lược đồ, biên giới xác thực và gói web đều đạt. Bằng chứng: `docs/evidence/p7-staging-long-series-preview-deployment-20260916.md`. Đây là cổng triển khai, chưa thay thế nghiệm thu tương tác chuỗi dài bằng tệp được phê duyệt.
   - **Bổ sung chọn lát gốc trực quan 2026-09-16:** các trang CatPhan, ACR và nhóm phantom CT (Cheese, Helios, Quart) nay dùng cùng vùng xem trước để chọn lát gốc; lựa chọn được đồng bộ ngược vào tham số `origin_slice` và chỉ áp dụng cho lượt phân tích mới. Tọa độ tâm vẫn giữ ở các ô điều chỉnh mà Pylinac hỗ trợ theo hợp đồng, không tự suy diễn một tâm tuyệt đối từ ảnh xem trước. Kiểm tra kiểu, lint, bản dựng và toàn bộ giao diện đạt `58/58`. Đây là cổng giao diện local; còn kiểm chứng staging với bộ phantom được phê duyệt, đối chiếu từng lớp và VERIFY/HANDOFF P7.
   - **Kiểm tra staging 2026-09-16:** API và giao diện đã cùng phục vụ commit `02c154238dbaac047634f50ff31e4638f9b6eda9`; mốc đồng bộ trong API buộc tiến trình nền tái dựng theo cùng source revision. Cổng exact-SHA công khai đạt `16/16`, readiness giữ lược đồ `20260914_0023`, tuyến xem trước và ranh giới xác thực đều đạt. Đây là bằng chứng parity triển khai, chưa phải chạy phantom được phê duyệt, đối chiếu độc lập hoặc nghiệm thu P7. Bằng chứng: `docs/evidence/p7-staging-visual-origin-slice-deployment-20260916.json`.
   - **Bổ sung UX 2026-09-16:** danh mục bài QA dùng ba cột ở màn hình rộng, hai cột ở màn hình trung bình và một cột ở màn hình hẹp; thẻ xác thực/chưa có đơn vị được thu gọn theo chiều dọc và tăng bề rộng hợp lý để giảm cuộn. Kiểm thử giao diện `53/53`, lint, kiểm tra kiểu và bản dựng đạt; cần kiểm tra parity staging tại 1366×768 và 1440×900 trước khi đóng lát cắt hiển thị.
   - **Bổ sung trình xem 2026-09-16:** kết quả lồng nhau do Pylinac trả về nay được trình bày thành các nhóm và dòng dễ đọc trong trình xem dùng chung; áp dụng cho CatPhan, ACR, VMAT, biên dạng, hạt nhân, ảnh phẳng và các bài tương tự. Tên tệp, mã hồ sơ, mã lượt chạy, mã đối tượng, mã bệnh nhân và đường dẫn bị ẩn; không hiển thị JSON, không tính lại chỉ số và không thay đổi kết quả đã lưu. Kiểm thử giao diện đạt `58/58`, kiểm tra kiểu, lint và bản dựng đạt. Bằng chứng: `docs/evidence/p7-local-structured-result-viewer-20260916.md`. Còn mở ROI chuyên biệt, ánh xạ tọa độ đa ảnh, fixture commissioning, staging tương tác và VERIFY/HANDOFF.
- [ ] P07-CAL — Hiệu chuẩn: TG-51 photon/electron phiên bản cũ/electron phiên bản hiện hành và TRS-398 photon/electron; biểu mẫu theo quy trình, hệ số và liều. Bộ tính hiện gọi trực tiếp hàm khởi tạo và thuộc tính kết quả công khai của đúng lớp Pylinac, không cần tệp đầu vào, hỗ trợ nhiều lần đọc và lưu hệ số/liều cùng lịch sử/đánh giá. Giao diện đã chặn trường trống, số không hợp lệ, miền tối thiểu và danh sách số đọc sai; TRS-398 electron dùng đúng `k_elec`. Kiểm thử hồi quy local đã đưa cả năm bài qua engine thật bằng số đo tổng hợp, đạt 5/5 đường chạy đúng và 1/1 trường hợp thiếu PDD10 bị chặn tại biên nhập liệu; không tạo ảnh minh họa vì các lớp hiệu chuẩn không có ảnh phân tích. Còn thiếu số đo chuẩn/commissioning cho từng lớp, đối chiếu độc lập kết quả, kiểm lỗi miền vật lý và kiểm chứng staging. Ghi rõ Pylinac chưa nhận bản sửa đổi TRS-398 năm 2024 nếu bản khóa chưa có.
- [ ] P07-STAR — Starshot: gantry/collimator/MLC/couch; UI chọn `start_point`, radius, peak/tolerance/FWHM/recursive/invert; tâm/tia/wobble overlay. Lát cắt local đã chạy bằng `Starshot`, hỗ trợ SID/DPI, tâm X/Y nhập từ giao diện, canvas click/drag dùng chung, lưu chỉ số/đánh giá/lịch sử và ảnh chú thích. Trình xem kết quả nay có bảng tâm vùng giao nhau, đường kính, bán kính, dung sai, kết luận Pylinac và từng góc tia; không hiển thị JSON hay khóa kỹ thuật. Còn thiếu ma trận fixture đầy đủ, đối chiếu độc lập và kiểm chứng staging.
- [ ] P07-VMAT — VMAT: DRGS, DRMLC, DRCS; cặp ảnh DICOM open/dynamic theo đúng thứ tự, dung sai, kích thước đoạn, khoảng cách xuyên tâm chuẩn trực riêng cho DRCS, chỉ số sai lệch và ảnh phân tích. Lát cắt local đã gọi trực tiếp ba lớp Pylinac, lưu kết quả/đánh giá/overlay và có giao diện chọn hai ảnh. Biểu mẫu nay chặn dung sai âm/không phải số, kích thước đoạn không dương và khoảng cách DRCS đảo chiều trước khi gửi; còn thiếu toàn bộ ma trận fixture, lựa chọn ROI/offset đầy đủ, canvas dùng chung và kiểm chứng staging.
- [ ] P07-CT — CatPhan 503/504/600/604/700; chuỗi/ZIP DICOM, origin slice, CTP module, HU/scaling/thickness/uniformity/MTF/low contrast/NPS và ROI adjustments. Lát cắt hiện đã có năm lớp adapter, kiểm tra số lượng/đuôi ZIP, tham số dung sai, lát gốc, điều chỉnh tâm/góc/vùng và giao diện. Biểu mẫu nay chặn số không hợp lệ, giá trị âm và lát gốc không phải số nguyên trước khi gửi. CatPhan 503/504/600/604 đã chạy bằng tệp mẫu chính thức, đều trả structured result 11 nhóm chỉ số và overlay; CatPhan 700 vẫn cần fixture tương thích. Còn thiếu đối chiếu từng mô-đun, kiểm thử lỗi đầy đủ và kiểm chứng staging.
- [ ] P07-ACR — ACR CT 464, MRI Large, MRI Medium; module/slice/ROI controls và toàn bộ structured results công khai. Lát cắt hiện đã nối cả ba lớp `ACRCT`, `ACRMRILarge`, `ACRMRIMedium` vào adapter Pylinac; API yêu cầu đúng một tệp ZIP DICOM, CT có lát gốc/điều chỉnh tâm-góc-vùng, MRI có thêm số lần vọng và tham số tương phản thấp; giao diện chỉ hiện trường MRI khi chọn bài MRI, đồng thời lưu overlay/lịch sử/đánh giá. Contract test, registry runtime và cổng định dạng đã đạt; chưa có fixture ACR trong môi trường hiện tại, chưa đối chiếu từng module structured result và chưa kiểm chứng staging.
- [ ] P07-CHEESE — TomoCheese và CIRS 062M; origin/ROI/reference density controls và density/HU outputs. Lát cắt hiện đã gọi đúng hai lớp Pylinac, nhận ZIP DICOM, điều chỉnh lát/tâm/góc/vùng, tùy chọn mật độ tham chiếu ROI và lưu kết quả/overlay/lịch sử. TomoCheese đã chạy bằng tệp mẫu chính thức, trả 27 nhóm chỉ số và overlay; CIRS 062M còn thiếu fixture. Còn thiếu đối chiếu ROI/đường mật độ, kiểm thử lỗi đầy đủ và staging.
- [ ] P07-HELIOS — GE Helios CT Daily; contrast scale, high contrast resolution, noise, uniformity, low contrast và điều chỉnh module/ROI. Lát cắt hiện đã nối lớp `GEHeliosCTDaily` với ZIP DICOM, điều chỉnh lát/tâm/góc/vùng và lưu kết quả/overlay/lịch sử; chưa có fixture Helios để xác nhận từng module và chưa kiểm chứng staging.
- [ ] P07-QUART — Quart DVT và nhãn/biến thể HyperSight còn công khai trong wheel; HU/geometry/uniformity/CNR/SNR và module controls. Lát cắt hiện đã nối `QuartDVT`; nhãn HyperSight dùng cùng bộ tính tương thích vì lớp cũ của Pylinac không còn nhận đúng đường dẫn đầu vào, không tạo thêm một engine hoặc lịch sử phân tích khác. Cả Quart DVT và nhãn HyperSight đã chạy bằng `quart.zip`, mỗi lần trả 10 nhóm chỉ số và overlay. Còn thiếu đối chiếu module, kiểm thử lỗi đầy đủ, xác nhận hiển thị nhãn và staging.
- [ ] P07-LOG — Dynalog và Trajectory Log 2.1/3.0/4.0, `.bin`/`.txt` theo class; bắt buộc chọn đúng cặp A/B cho Dynalog, giữ nguyên tên tệp để Pylinac ghép cặp, kiểm phiên bản Trajectory trước khi phân tích, hiển thị Axis/MLC/beam-hold/fluence và chỉ tạo Gamma fluence khi người dùng nhập đủ dung sai liều và khoảng cách. Lát cắt local đã gọi Dynalog và Trajectory 2.1 bằng dữ liệu demo thật, tạo chỉ số và biểu đồ MLC; Gamma Dynalog đã được kiểm tra bằng bản đồ thật `60 × 4000` và 240.000 điểm hợp lệ. Còn thiếu fixture thực tế cho Trajectory 3/4, Gamma của các phiên bản Trajectory tương ứng và staging có đăng nhập.
...
- [ ] P07-WL — Winston–Lutz một target: bộ ảnh ZIP, đọc góc từ siêu dữ liệu DICOM, tên tệp hoặc nhập theo thứ tự từng ảnh, SID/DPI, kích thước bi, ngưỡng nhận diện, góc tham chiếu, BB/CAX từng ảnh, isocenter/axis plots và dịch chuyển bàn khi phù hợp. Lát cắt local đã gọi `WinstonLutz.from_zip()`/`analyze()` thật, lưu metrics và ảnh phân tích, có giao diện tham số, lịch sử, nhập góc tay theo từng ảnh và bảng véc-tơ CAX–bi theo từng ảnh; máy chủ ghép ánh xạ vào đúng thành viên ZIP trước khi gọi Pylinac, chặn thiếu góc và sai số dòng. Còn thiếu ma trận fixture đầy đủ, đối chiếu độc lập, điều chỉnh trực quan theo từng ảnh trong phạm vi Pylinac hỗ trợ và kiểm chứng staging.
- [ ] P07-WLMT — Winston–Lutz Multi-Target/Multi-Field: form cấu hình BB/field/tọa độ/mapping và ghép cặp/overlay; không bắt tệp cấu hình thô. Lát cắt local đã dùng trực tiếp `WinstonLutzMultiTargetMultiField.from_zip()`/`analyze()` với bảng cấu hình sáu bi, có lựa chọn trường mở/mật độ thấp, lưu kết quả và ảnh tổng hợp. Đã bổ sung lựa chọn đọc góc từ thông tin ảnh, tên tệp hoặc nhập theo thứ tự ảnh; khi nhập tay, giao diện tự tạo một dòng cho mỗi ảnh và máy chủ ghép đúng thứ tự ZIP, đồng thời chặn thiếu góc hoặc sai số dòng trước khi gọi Pylinac. Còn thiếu ánh xạ tọa độ/ghép cặp trực quan theo từng ảnh, ma trận fixture đầy đủ và kiểm chứng staging.
- [ ] P07-PLANAR — Toàn bộ Planar Imaging: Leeds/Blue, SI QC-3/QC-kV, Las Vegas/Elekta, Doselab MC2 MV/kV, SNC MV/MV12510/kV, PTW EPID QC, IBA Primus A, SI FC-2, IMT L-RAD, Doselab RLf, IsoAlign, SNC FSQA, ACR Digital Mammography. Lát cắt hiện đã nối đủ 19 lớp Pylinac, kiểm tra đúng một ảnh, truyền tham số phantom/tâm/góc/vùng quan tâm, dùng canvas chung để chọn tâm, lưu overlay/lịch sử và có giao diện chung. Cả 19 lớp đã chạy qua đúng `execute_pylinac` bằng tệp mẫu chính thức, trả structured result và overlay; bài IBA cần `SSD = 1395 mm` theo bộ mẫu. Bộ chuyển đổi dùng đúng `plot_analyzed_image()` của Pylinac 3.47.0. Còn thiếu đối chiếu từng module theo kỳ vọng upstream, kiểm thử lỗi đặc trưng và kiểm chứng staging.
- [ ] P07-FPA — Field Profile Analysis: manual/beam/geometric center, vị trí và độ rộng x/y, normalization, edge type và toàn bộ profile metrics công khai. Lát cắt local đã gọi `FieldProfileAnalysis.analyze()`/`results_data()`/`plot_analyzed_images()`, có biểu mẫu tham số, canvas chung cho chọn vị trí thủ công, lịch sử, đánh giá và ảnh phân tích; còn thiếu đầy đủ dữ liệu biên dạng và kiểm chứng staging.
- [ ] P07-FA — Field Analysis legacy: UI tương thích EPID/SNC Profiler và protocol cũ; nhãn mô-đun cũ, bài mới mặc định FPA nhưng không loại capability khỏi catalog. Lát cắt local đã gọi `FieldAnalysis.analyze()`/`results_data()`/`plot_analyzed_image()`, có lựa chọn protocol, nội suy, tâm, chuẩn hóa, canvas chung cho chọn vị trí thủ công và ảnh phân tích; còn thiếu ma trận fixture legacy đầy đủ và kiểm chứng staging.
- [ ] P07-NUCLEAR — Chín bài hạt nhân của Pylinac: tốc độ đếm cực đại, độ đồng nhất phẳng, tâm quay, độ phân giải cắt lớp, độ nhạy đơn giản, độ phân giải bốn vạch, độ phân giải bốn góc, độ đồng nhất cắt lớp và độ tương phản cắt lớp. Đã có chín nhánh adapter, chín biểu mẫu riêng, kiểm tra tệp DICOM, tham số theo từng lớp, ánh xạ kết quả cấu trúc và lịch sử/đánh giá/ảnh minh họa trong giao diện. Bài độ nhạy cho phép ảnh nền tùy chọn; các bài còn lại nhận đúng số tệp theo hợp đồng. Kiểm thử hồi quy local đã dựng fixture DICOM tổng hợp không có dữ liệu bệnh nhân và gọi thật đủ chín lớp qua `execute_pylinac`, đạt 1/1 kiểm thử; đây chỉ là bằng chứng đường chạy engine, không thay thế fixture đại diện. Còn cần fixture DICOM chuẩn hoặc dữ liệu commissioning được phê duyệt, đối chiếu trực tiếp từng trường `results_data()`, kiểm lỗi đặc trưng và staging trước khi đánh dấu hoàn thành.
- [ ] P07-CONTRIB — One-Offs/Contrib: `QuasarLightRadScaling` và `JawOrthogonality`; đã dùng đúng hai lớp Pylinac, có biểu mẫu ảnh riêng, tham số `normalize/invert/FWXM/ngưỡng cạnh` cho Quasar, tự phát hiện bốn cạnh cho Jaw, lưu `source_tier=PYLINAC_CONTRIB`, lịch sử, đánh giá và ảnh minh họa. Quasar dùng `results_data()`; Jaw dùng `results()` vì upstream không cung cấp `results_data()` cho lớp này. Kiểm thử hồi quy local đã đưa cả hai lớp qua `execute_pylinac` bằng fixture tổng hợp không có dữ liệu bệnh nhân và đạt 2/2, trong đó Quasar dùng bản sao tạm của ảnh FC-2 chính thức có bổ sung bốn điểm chuẩn. Cần fixture chuẩn/commissioning, đối chiếu trực tiếp từng chỉ số, kiểm lỗi thiếu cạnh/ảnh không phù hợp và kiểm chứng staging.
...
- TC-UX1-P07-S03 — P07-CAL: mỗi lớp TG-51/TRS-398 nhận form đúng trường/đơn vị, không yêu cầu tệp, adapter trả đúng các thuộc tính kết quả công khai của Pylinac; nhãn protocol/version chính xác và đánh giá người dùng vẫn độc lập với phép tính.
...
- TC-UX1-P07-S05 — P07-VMAT: DRGS/DRMLC/DRCS nhận đúng hai ảnh open/dynamic theo thứ tự người dùng chọn; từ chối thiếu/thừa ảnh, truyền đúng tolerance/segment và khoảng cách xuyên tâm DRCS, lưu deviation/overlay khớp kết quả Pylinac.
- TC-UX1-P07-S06 — P07-CT: CatPhan 503/504/600/604/700 đi qua chuỗi ảnh, module metrics và origin/ROI adjustment; run chỉnh tay không overwrite run auto.
...
- TC-UX1-P07-S16 — P07-FPA: vị trí profile đồng bộ ô số và canvas chung, centering/width/edge/normalization/metrics được truyền đúng, biểu đồ khớp structured result; thao tác click chỉ tạo run mới sau khi người dùng xác nhận điều chỉnh.
- TC-UX1-P07-S17 — P07-FA: dữ liệu legacy vẫn mở/chạy bằng class legacy, protocol/nội suy/chuẩn hóa được truyền đúng, có nhãn mô-đun cũ; tạo bài mới mặc định đưa người dùng sang FPA.
...
- [ ] P08-W02 — Form luôn hiện ΔD (%), DTA (mm), global/local, low-dose threshold và pass-rate target; nâng cao có ROI/gamma cap và profile định dạng đo. Resampling chỉ được đánh dấu hoàn thành sau khi có capability, kiểm thử và bằng chứng riêng; không coi việc kiểm lưới hiện tại là resampling. Lát cắt local hiện đã hiển thị và lưu thêm phép nội suy trên lưới đã kiểm tra, số khoảng biểu đồ và hệ số tinh chỉnh một chiều; hệ số này chỉ có hiệu lực với Gamma 1D, không bật resampling ngầm. Giao diện PSQA chỉ cho chọn tệp RTDOSE hoặc dữ liệu đo đã hợp lệ; không hiển thị tệp JSON kỹ thuật và không dùng tên tệp nội bộ làm nhãn người dùng.
  Kiểm chứng staging đã đạt riêng cổng nhãn đầu vào: bốn lựa chọn được trình bày bằng `Tệp liều RTDOSE 1/2` và `Dữ liệu đo liều 1/2`, không lộ phần mở rộng JSON hoặc mã nội bộ; các trường ΔD, DTA, ngưỡng, chuẩn hóa và giới hạn Gamma vẫn hiển thị. Bằng chứng: [P8 nhãn đầu vào PSQA staging](docs/evidence/p8-staging-psqa-input-labels-20260915.md). Đây là kiểm tra giao diện chỉ đọc, chưa phải cổng chạy Gamma staging.
  Lát cắt UX kế tiếp đã áp dụng cùng nguyên tắc cho toàn bộ màn hình Pylinac, kho tệp QA và lựa chọn dữ liệu DVH: chỉ dùng nhãn nghiệp vụ, không đưa tên tệp, chuỗi băm hoặc mã nội bộ ra giao diện. Bằng chứng local: [nhãn dữ liệu QA theo ngôn ngữ người dùng](docs/evidence/p7-p8-user-facing-artifact-labels-20260915.md). Cần triển khai web và kiểm tra trình duyệt staging trước khi ghi nhận parity.
  Cập nhật kiểm tra tham số PSQA 2026-09-18: biểu mẫu chặn ngay chênh lệch liều hoặc DTA không dương, ngưỡng ngoài 0–100%, giới hạn Gamma ngoài 1–10, số khoảng biểu đồ không nguyên/ngoài 2–100, hệ số tinh chỉnh một chiều không nguyên/ngoài 1–10 và yêu cầu phân tích ba chiều mới. Lỗi hiển thị bằng tiếng Việt, nút bắt đầu bị khóa và không gửi tác vụ sang máy chủ. Kiểm thử riêng đạt `7/7`, toàn bộ giao diện đạt `78/78`, kiểm tra kiểu, lint và bản dựng đạt. Bằng chứng: `docs/evidence/p8-local-psqa-configuration-validation-20260918.md`. Đây là cổng UX local; còn kiểm chứng chạy Gamma thật trên staging, ma trận lỗi hàng đợi và VERIFY/HANDOFF P8.
  Kiểm tra parity staging P8-W02 2026-09-18: API, giao diện và tiến trình nền đã dựng lại cùng commit `e9f1b9a011b12c461f3d14b4bc060d29655f59d3`; bộ xác minh công khai exact-SHA đạt `16/16`, readiness `200`, lược đồ `20260914_0023` và gói giao diện mới đều hiện diện. Bằng chứng: `docs/evidence/p8-staging-psqa-configuration-validation-20260918.json`. Đây chỉ là parity triển khai và kiểm tra biên chưa cần đăng nhập; chưa chạy Gamma thật bằng dữ liệu liều staging và chưa đóng P08-W02.
  Cập nhật preflight hình học 2026-09-18: máy chủ và giao diện nay kiểm tra trước khi tạo lượt phân tích các điều kiện Pylinac cần: đúng số chiều, cùng kích thước lưới, cùng khoảng cách điểm ảnh, cùng gốc tọa độ, điểm ảnh vuông cho Gamma hai chiều và DTA là bội số nguyên của kích thước điểm ảnh. Sai điều kiện được báo bằng tiếng Việt và nút bắt đầu bị khóa; không tạo thêm lượt chờ rồi mới thất bại ở worker. Kiểm thử local của API đạt `21/21`, kiểm thử riêng giao diện đạt `8/8`, kiểm tra kiểu, lint và bản dựng đạt. Sau khi triển khai mã `a686905c592955b4fc6a52945e42cd70bb75d21e`, cổng công khai staging đạt `16/16`; kiểm tra có đăng nhập xác nhận cấu hình hai chiều không phù hợp bị chặn trước khi tạo lượt mới. Bằng chứng: `docs/evidence/p8-staging-gamma-preflight-20260918.json` và `docs/evidence/p8-staging-public-gamma-preflight-20260918.json`.
- [ ] P08-W03 — Queue status/retry/cancel và kết quả 1D/2D gồm map/profile, histogram, pass rate, evaluated/excluded/invalid counts và cảnh báo vùng không đánh giá. Lát cắt local hiện đã có tuyến hủy trước khi worker nhận việc, trạng thái `CANCELLED`, nhật ký hủy, cập nhật outbox và worker bỏ qua thông điệp cũ; kiểm thử Gamma đạt 15/15 theo [bằng chứng hàng đợi và kết quả Gamma cục bộ](docs/evidence/p8-local-gamma-queue-results-20260918.md). Vẫn cần kiểm chứng queue thật trên staging cùng toàn bộ ma trận lỗi.
  Lát cắt chạy thật Gamma hai chiều trên staging đã đạt: hai RTDOSE tổng hợp được kiểm tra hợp lệ, lượt Pylinac hoàn tất Đạt 100% (4/4 điểm, Gamma P95 0,083), bản đồ và histogram hiển thị. Bằng chứng: [Gamma hai chiều Pylinac staging](docs/evidence/p8-staging-gamma-2d-pylinac-20260918.json). Lát cắt này không đóng toàn bộ P08-W03; queue retry/cancel, ma trận lỗi và các đầu vào 1D vẫn phải kiểm tra.
  Cổng đầu vào một chiều đã được sửa và kiểm tra cục bộ: tệp đo liều `gamma.measurement.v1` có lưới `[n]` và trục `x` nay được xác thực đúng, hình học hai hồ sơ một chiều được chấp nhận trước khi đưa vào hàng đợi. Bằng chứng: [đầu vào Gamma một chiều Pylinac cục bộ](docs/evidence/p8-local-gamma-1d-pylinac-20260918.md). Đây là cổng local; việc chạy thật trên staging đã được ghi nhận ở dòng kế tiếp.
  Cổng chạy thật Gamma một chiều trên staging đã đạt ngày 2026-09-18: hai tệp số đo tổng hợp đã kiểm tra hợp lệ được chọn trên giao diện, Pylinac hoàn tất với kết luận Đạt, tỷ lệ đạt 100%, 4/4 điểm đạt, 0 điểm loại khỏi tính toán, độ bao phủ 1 và Gamma P95 bằng 0; bảng vị trí và biểu đồ phân bố hiển thị, lịch sử lượt chạy được cập nhật. Bằng chứng: [Gamma một chiều Pylinac staging](docs/evidence/p8-staging-gamma-1d-pylinac-20260918.json). Giao diện cũng tự chọn hai số đo khi chuyển sang kiểu một chiều và không còn khóa nút do điều kiện RTDOSE cũ. Happy path 1D/2D đã có bằng chứng staging; P08-W03 vẫn mở queue retry/cancel, ma trận lỗi và các cổng VERIFY/HANDOFF.
  Kiểm chứng thử lại trên staging ngày 2026-09-18: mở một lượt Gamma một chiều lỗi trong lịch sử, bấm `Phân tích lại`, nhận thông báo đã đưa lại vào hàng chờ, thấy lần thực hiện tăng từ 1 lên 2 và tiến độ trung gian 25%. Vì dữ liệu tổng hợp của lượt lỗi vẫn thiếu đúng một khoảng cách và gốc tọa độ, worker trả lại `FAILED` với thông báo cụ thể và không tạo kết quả đạt giả. Bằng chứng: [Gamma retry staging](docs/evidence/p8-staging-gamma-retry-20260918.json).
  Cổng hủy khi còn nằm trong hàng chờ đã được kiểm chứng trên staging ngày 2026-09-18 bằng worker riêng ở chế độ chờ có kiểm soát: lượt mới hiển thị `Đang chờ`, nút `Hủy phân tích` hủy thành công, kết quả chuyển `Đã hủy`, tiến độ vẫn 0%, lần thực hiện 0 và không tạo snapshot. Sau đó đã gỡ cờ bảo trì, worker trở lại `Online` và một lượt tổng hợp mới đạt `100%`, 4/4 điểm. Bằng chứng: [Gamma cancel staging](docs/evidence/p8-staging-gamma-cancel-20260918.json). P08-W03 vẫn mở cho ma trận lỗi worker/Redis, giới hạn tài nguyên, oracle độc lập và các cổng VERIFY/HANDOFF.
  Kiểm tra âm trên staging ngày 2026-09-18: ở kiểu một chiều, cố ý chọn một tệp RTDOSE làm tham chiếu và một tệp số đo làm đối chiếu. Giao diện hiện `Thiếu dữ liệu phù hợp`, báo `Gamma một chiều cần hai dãy liều một chiều.`, khóa nút bắt đầu, giữ nguyên lịch sử 21 lượt và không tạo mục hàng chờ mới; khôi phục tệp số đo hợp lệ thì nút được mở lại. Bằng chứng: [Gamma một chiều preflight âm staging](docs/evidence/p8-staging-gamma-1d-preflight-negative-20260918.json).
  Ma trận hàng đợi Redis/worker cục bộ đã chạy lại trên mã nguồn hiện tại: đường chạy đúng, gửi trùng được khử, lỗi xác nhận được phục hồi mà không tạo lần chạy thứ hai, thử lại có giới hạn đưa vào khu cách ly, thông điệp sai được cách ly và số mục chờ sau xác nhận là 0. Bằng chứng: `docs/evidence/p8-local-redis-worker-smoke-20260918.json`. Đây là bằng chứng cục bộ cho hợp đồng worker; không thay thế kiểm thử lỗi worker/Redis thật trên staging.
...
- TC-UX1-P08-E11 — Chọn lưới hai chiều nhưng một đầu vào là lưới ba chiều → báo ngay không tương thích số chiều, không tạo lượt phân tích.
- TC-UX1-P08-E12 — Hai tệp khác shape hoặc spacing → báo không tương thích lưới, giữ nguyên tệp đã chọn và lịch sử cũ.
- TC-UX1-P08-E13 — Hai tệp khác gốc tọa độ hoặc DTA không chia hết cho spacing → báo điều kiện hình học, không tự căn chỉnh hoặc làm tròn âm thầm.
- TC-UX1-P08-E14 — Metadata hình học bị thiếu/hỏng → báo cần kiểm tra lại tệp, không đẩy dữ liệu không chắc chắn vào hàng đợi.
...
- [ ] P09-W01 — Tích hợp trình biên soạn theo ngữ cảnh kết quả, bộ chọn bằng tên nghiệp vụ, mọi khối đều ẩn được; nguồn **kết quả Pylinac** nay chọn được theo bài và lần phân tích, đồng thời snapshot giữ liên kết lớp phủ để renderer dùng tiếp. Lát cắt cục bộ đã đạt theo [bằng chứng trình biên soạn báo cáo](docs/evidence/p9-local-report-builder-user-facing-20260918.md) và [bằng chứng nguồn Pylinac](docs/evidence/p9-local-pylinac-report-source-20260918.md). Kiểm tra staging có đăng nhập đã tải được lịch sử và bộ chọn nguồn/khối bằng nhãn nghiệp vụ theo [bằng chứng chỉ đọc staging](docs/evidence/p9-staging-report-builder-readonly-20260918.json); luồng có đăng nhập tiếp theo đã lưu một báo cáo Gamma từ hồ sơ tổng hợp, giữ bản chụp nguồn và bản 1 theo [bằng chứng xuất báo cáo Gamma staging](docs/evidence/p9-staging-authenticated-report-export-20260918.json). Vẫn còn đối chiếu PDF/preview và VERIFY/HANDOFF.
- [ ] P09-W02 — Mở rộng snapshot/layout/render contract, định dạng số/locale, tránh chỉnh metric gốc qua template; lát cắt PDF/CSV không lộ mã kỹ thuật đã đạt cục bộ theo [bằng chứng renderer báo cáo](docs/evidence/p9-local-report-renderer-user-facing-20260918.md), còn chờ hợp đồng bố cục đầy đủ.
- [ ] P09-W03 — Renderer dùng ảnh+overlays thật từ kết quả Pylinac, font tiếng Việt, bảng qua trang, preview cùng engine; lát cắt font, nội dung ghi chú, chia PDF nhiều trang, nhúng lớp phủ ảnh vào PDF/PNG và xem trước từ cùng renderer đã đạt cục bộ theo [bằng chứng renderer báo cáo](docs/evidence/p9-local-report-renderer-user-facing-20260918.md) và [bằng chứng xem trước cùng renderer](docs/evidence/p9-local-preview-renderer-20260918.md), parity triển khai PDF/PNG staging đạt theo [bằng chứng PDF/PNG trên staging](docs/evidence/p9-staging-pylinac-overlay-png-20260918.json). Luồng có đăng nhập đã dựng xem trước từ bản lưu và xuất PDF hoàn tất theo [bằng chứng xuất báo cáo Gamma staging](docs/evidence/p9-staging-authenticated-report-export-20260918.json); kiểm tra PDF đã xác nhận chữ Việt và bố cục cơ bản, nhưng nguồn Gamma tổng hợp chưa có ảnh kết quả nên chưa nghiệm thu được lớp phủ thực. Còn thiếu kiểm tra ảnh phân tích thực, bảng nghiệp vụ nhiều trang và VERIFY/HANDOFF.
- [ ] P09-W04 — Export idempotency theo snapshot/layout/renderer và history tải lại, deletion propagation. Hợp đồng xuất lặp bốn định dạng, lịch sử theo bản sửa đổi, phân trang, nút lấy liên kết tải mới và bù trừ lỗi lưu đã đạt cục bộ theo [bằng chứng xuất lặp](docs/evidence/p9-local-export-idempotency-20260918.md); API/web/worker staging đã đạt parity exact-SHA 16/16 theo [bằng chứng lịch sử tệp trên staging](docs/evidence/p9-staging-export-history-20260918.json). Luồng có đăng nhập đã xuất PDF hoàn tất, hiển thị một mục trong lịch sử tệp và kiểm tra nút `Tải lại` theo [bằng chứng xuất báo cáo Gamma staging](docs/evidence/p9-staging-authenticated-report-export-20260918.json). Vẫn cần đối chiếu byte/nội dung tệp tải về, xuất lặp/mất mạng trên staging và VERIFY/HANDOFF. Lan truyền xóa vĩnh viễn được giữ ngoài phạm vi theo quyết định sản phẩm hiện tại; hồ sơ QA dùng lưu trữ/khôi phục.
