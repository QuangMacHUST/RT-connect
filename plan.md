...
> Cập nhật candidate staging ngày 2026-09-11: sau khi queue orchestration được harden và cập nhật evidence, API `f163ec99-19c2-48d6-b685-9cf50a6b7cdf`, web `ae8fe82e-0a84-4a1b-b1f3-a0efda9999f9` và worker `d02d5508-e184-4f51-84d4-4c1f3d927e17` đều `SUCCESS` trên source SHA `7d0cd51426a0b141a93948c32ed9a324afefb1b1`. Public verifier đạt `15/15`, schema `20260909_0019`; web bundle đã chứa upload queue. Fixture RTDOSE tổng hợp `gamma-rtdose-v1-smoke.dcm` đã được upload một lần trước đó vào case staging `ed7ddbe5-811a-4463-a270-b0386f64644d` với `REFERENCE/DICOM`, manifest được tạo và validation `VALID` (0 lỗi, 0 cảnh báo). Đây là `STAGING_VERIFIED_SLICE`, không tự đóng P06-W04/P06-VERIFY hoặc các gate fault/retry, signed-download byte re-hash, storage reconciliation, release và handoff. Evidence parity: `docs/evidence/p20-staging-public-parity-20260911-7d0cd51.json`; upload: `docs/evidence/p06-staging-rtdose-upload-20260911.json`.
