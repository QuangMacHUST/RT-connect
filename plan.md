...
- [ ] P09-W04 — Export idempotency theo snapshot/layout/renderer và history tải lại, deletion propagation. Hợp đồng xuất lặp bốn định dạng, xung đột khóa và bù trừ lỗi lưu đã đạt cục bộ theo [bằng chứng xuất lặp](docs/evidence/p9-local-export-idempotency-20260918.md); còn kiểm thử có đăng nhập trên staging và đối chiếu lịch sử. Lan truyền xóa vĩnh viễn được giữ ngoài phạm vi theo quyết định sản phẩm hiện tại; hồ sơ QA dùng lưu trữ/khôi phục.
