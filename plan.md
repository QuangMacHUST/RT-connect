...
Evidence hiện tại: `docs/evidence/p4-local-organization-ui-20260913-8a1fe44.json`, `docs/evidence/p4-local-machine-creation-20260913.json`, `docs/evidence/p4-local-organization-api-20260913.json`, `docs/evidence/p4-local-qa-history-20260913.json`, `docs/evidence/p4-staging-verified-20260913-8a1fe44.json`, `docs/evidence/p4-staging-public-verifier-20260913-e8c4323.json`, `docs/evidence/p4-staging-public-verifier-20260913-9d95f89.json`, `docs/evidence/p4-staging-public-verifier-20260913-b53916c.json`, `docs/evidence/p4-staging-public-verifier-20260913-d329ab7.json`, `docs/evidence/p4-staging-invite-inbox-20260913-246d1e5.json` và `docs/evidence/p4-staging-invite-qa-readback-20260913-246d1e5.json`. Bằng chứng mới nhất xác nhận bản sửa biểu mẫu, kiểm hủy lưu trữ máy, source parity, triển khai đồng bộ ba dịch vụ trên staging, luồng hộp thư lời mời/nhận lời mời và quyền đọc lại cơ sở/máy/lịch sử QA của người nhận; lát cắt này không thay cho kiểm xung đột hai danh tính, mã mời sai, vòng đời lưu trữ/khôi phục hoặc bàn giao P4. Trình tự kiểm tra cuối được ghi tại [phiếu kiểm chứng hai tài khoản](docs/runbooks/p4-kiem-chung-hai-tai-khoan-staging.md).
