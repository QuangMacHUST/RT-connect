...
**Bổ sung P7-W03 2026-09-16:** thêm cổng đối chiếu 10 chỉ số lõi với giá trị tham chiếu của bộ mẫu chính thức Pylinac `3.47.0`; kiểm thử `-k core_metric` đạt `10/10`. Đây là kiểm tra ánh xạ với engine đã khóa, không phải oracle độc lập hoặc nghiệm thu lâm sàng. Bằng chứng: `docs/evidence/p7-local-official-core-metric-reference-20260916.md`. Các fixture đại diện/commissioning, oracle độc lập, staging toàn bộ nhóm và VERIFY/HANDOFF P7 vẫn mở.
