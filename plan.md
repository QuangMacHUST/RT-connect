...
- [ ] P08-W03 — Queue status/retry/cancel và kết quả 1D/2D gồm map/profile, histogram, pass rate, evaluated/excluded/invalid counts và cảnh báo vùng không đánh giá. Lát cắt local hiện đã có tuyến hủy trước khi worker nhận việc, trạng thái `CANCELLED`, nhật ký hủy, cập nhật outbox và worker bỏ qua thông điệp cũ; vẫn cần kiểm chứng queue thật trên staging cùng toàn bộ ma trận lỗi.
