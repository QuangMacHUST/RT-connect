...
> Cập nhật candidate staging ngày 2026-09-11: API deployment `0c1af92e-852d-4abf-a847-7a08fa6a4a4f`, web `6ef433a8-5c77-47a4-9239-c09a4bc8d5db` và worker `c0c938aa-7250-4caa-9a03-9e466eeb6b23` đều `SUCCESS` trên cùng source SHA `c0a8b82edeb4bdbc3461e6df6182a894f7c90208`. Public verifier đạt `15/15`, schema `20260909_0019`; web bundle chứa contract `DownloadResponse.filename` và source marker. Fixture RTDOSE tổng hợp `gamma-rtdose-v1-smoke.dcm` đã được upload một lần trước đó vào case staging `ed7ddbe5-811a-4463-a270-b0386f64644d` với `REFERENCE/DICOM`, manifest được tạo và validation `VALID` (0 lỗi, 0 cảnh báo). Read-only download giữ đủ 898 bytes và SHA-256 khớp fixture; Edge vẫn giữ hậu tố `.crdownload`, nên final filename/header readback qua browser vẫn là `UNVERIFIED`. Đây là `STAGING_VERIFIED_SLICE`, không tự đóng P06-W04/P06-VERIFY hoặc các gate fault/retry, storage reconciliation, release và handoff. Evidence rollout: `docs/evidence/p20-staging-public-parity-20260911-c0a8b82.json`; download: `docs/evidence/p06-staging-rtdose-download-20260911-1984c04.json`; upload cũ giữ nguyên: `docs/evidence/p06-staging-rtdose-upload-20260911.json`.
