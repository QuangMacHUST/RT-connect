...
- [ ] P09-W03 — Renderer dùng ảnh+overlays thật từ kết quả Pylinac, font tiếng Việt, bảng qua trang, preview cùng engine; lát cắt font, nội dung ghi chú, chia PDF nhiều trang, nhúng lớp phủ ảnh vào PDF/PNG và xem trước từ cùng renderer đã đạt cục bộ theo [bằng chứng renderer báo cáo](docs/evidence/p9-local-report-renderer-user-facing-20260918.md) và [bằng chứng xem trước cùng renderer](docs/evidence/p9-local-preview-renderer-20260918.md), parity triển khai PDF/PNG staging đạt theo [bằng chứng PDF/PNG trên staging](docs/evidence/p9-staging-pylinac-overlay-png-20260918.json). Luồng có đăng nhập đã dựng xem trước từ bản lưu và xuất PDF hoàn tất theo [bằng chứng xuất báo cáo Gamma staging](docs/evidence/p9-staging-authenticated-report-export-20260918.json); còn thiếu kiểm tra trực quan nội dung PDF/ảnh phân tích thực, bảng nghiệp vụ nhiều trang và VERIFY/HANDOFF.
