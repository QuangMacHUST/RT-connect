...
def verify(root: Path) -> dict[str, object]:
    ...
    expected_versions = {
        ...
        "technical": (r"\*\*Phiên bản:\*\*\s*([0-9]+\.[0-9]+)", "1.17"),
        "plan": (r"Phiên bản:\s*\*\*([0-9]+\.[0-9]+)\*\*", "4.5"),
    }
    ...
    references = {
        "business": "plan.md v4.5",
        "specification": "plan.md v4.5",
        "technical": "plan.md v4.5",
        "progress": "plan.md v4.5",
    }
