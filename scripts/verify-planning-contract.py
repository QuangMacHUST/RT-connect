...
def verify(root: Path) -> dict[str, object]:
    ...
    expected_versions = {
        "business": (r"\*\*Phiên bản tài liệu:\*\*\s*([0-9]+\.[0-9]+)", "0.27"),
        "specification": (r"version \*\*([0-9]+\.[0-9]+)\*\*", "1.28"),
        "technical": (r"\*\*Phiên bản:\*\*\s*([0-9]+\.[0-9]+)", "1.27"),
        "plan": (r"Phiên bản:\s*\*\*([0-9]+\.[0-9]+)\*\*", "4.24"),
    }
    ...
    references = {
        "business": "plan.md v4.24",
        "specification": "plan.md v4.24",
        "technical": "plan.md v4.24",
        "progress": "plan.md v4.24",
    }
    ...
    required_markers = {
        "business.feature_card": (business, "## 23. Hợp đồng bàn giao nghiệp vụ v0.27"),
