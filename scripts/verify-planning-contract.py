...
def verify(root: Path) -> dict[str, object]:
    ...
    expected_versions = {
        ...
        "technical": (r"\*\*Phiên bản:\*\*\s*([0-9]+\.[0-9]+)", "1.30"),
        "plan": (r"Phiên bản:\s*\*\*([0-9]+\.[0-9]+)\*\*", "4.25"),
    }
    ...
    references = {
        "business": "plan.md v4.25",
        "specification": "plan.md v4.25",
        "technical": "plan.md v4.25",
        "progress": "plan.md v4.25",
    }
