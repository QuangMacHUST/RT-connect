...
- **Not yet evidenced:** authenticated browser selection of a real saved DVH run, PostgreSQL source/evaluation hash query, CT anatomy renderer, resource/fault/volume gates and independent/reference DVH oracle. Deployment/readiness of this candidate is verified, but the local contract plus health/readiness are not a complete staging workflow or clinical-readiness claim.
