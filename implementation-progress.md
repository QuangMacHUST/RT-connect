...
- P4 đã bắt đầu và đạt `LOCAL_VERIFIED_SLICE` cho lát cắt giao diện Đơn vị và thiết bị: thẻ đơn vị, cơ sở/máy cạnh nhau, thành viên/lời mời thu gọn; lint, typecheck, Vitest **23/23** và production build PASS. Evidence: [P4 local organization UI](docs/evidence/p4-local-organization-ui-20260913.json). P4 vẫn mở để kiểm hai danh tính, xung đột phiên bản, lưu trữ/khôi phục và staging.
