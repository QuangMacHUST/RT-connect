...
- **Current phase:** P2/P3 — Railway deployment foundation complete; Auth/API and dashboard vertical slice is implemented on a release branch.
- **Current status:** IN_PROGRESS — staging and production API deployments are live and externally verified. P2 Supabase Auth/application smoke and P3 live web deployment remain pending.
- **Last authoritative check:** 2026-09-06 — Railway metadata and public endpoint verification after region correction.
- **Next exact step:** complete the Supabase Auth environment decision and live sign-in/membership smoke on staging before promoting the P3 web/API slice.
