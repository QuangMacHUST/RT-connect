...
- Cổng phụ thuộc pylinac ngày 2026-09-14: `pylinac==3.47.0` import được trong môi trường API; khóa cài đặt đã bổ sung toàn bộ phụ thuộc trực tiếp/phụ trợ, `pydicom` đồng bộ về `2.4.5` theo yêu cầu của pylinac, `pip check` và cài đặt thử từ khóa đều đạt. Toàn bộ API, ruff, mypy nghiêm ngặt và web 31/31 tiếp tục đạt. Đây là kiểm tra chuẩn bị cho P7, chưa phải bằng chứng các adapter/bài QA pylinac đã chạy; P5 vẫn giữ các cổng staging xóa vĩnh viễn, lỗi mạng và tiến trình nền.
