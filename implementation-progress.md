...
| P4 | STAGING CRUD PASS / INVITATION E2E OPEN | Organization/site/machine lifecycle remains evidenced; invitation/member migration `20260909_0018` and public routes are deployed/readiness-ready on candidate `2fcf065`, with version-label parity pass; Auth/two-identity browser lifecycle, direct PostgreSQL/hash/status/audit, replay/revoke/expiry/context/concurrency/timeout remain open |
