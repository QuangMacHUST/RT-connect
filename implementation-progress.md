...
- P4 đã đạt `STAGING_VERIFIED_SLICE` cho lát cắt giao diện Đơn vị và thiết bị: thẻ đơn vị, cơ sở/máy cạnh nhau, thành viên/lời mời thu gọn; lint, typecheck, Vitest **24/24**, production build PASS, ba dịch vụ staging cùng mã `8a1fe44f68b81855ba81bb3c77e920fcbf7867c9`, public verifier **17/17**. Biểu mẫu tạo máy chỉ yêu cầu tên hiển thị và máy chủ tự tạo mã nội bộ; lỗi nghiệp vụ P4 được dịch sang tiếng Việt. API P4 cục bộ đạt **16/16** kiểm thử về phạm vi, sửa đồng thời, thành viên, lời mời, tự tạo mã và lưu trữ/khôi phục. Evidence: [P4 local UI](docs/evidence/p4-local-organization-ui-20260913-8a1fe44.json), [P4 local API](docs/evidence/p4-local-organization-api-20260913.json), [P4 local machine creation](docs/evidence/p4-local-machine-creation-20260913.json), [P4 staging](docs/evidence/p4-staging-verified-20260913-8a1fe44.json), [P4 public verifier](docs/evidence/p4-staging-public-verifier-20260913-8a1fe44.json). P4 vẫn mở để kiểm hai danh tính thật, bộ chọn bài QA và lịch sử trên staging.
