...
- P4 đã đạt `STAGING_VERIFIED_SLICE` cho lát cắt giao diện Đơn vị và thiết bị: thẻ đơn vị, cơ sở/máy cạnh nhau, thành viên/lời mời thu gọn; lint, typecheck, Vitest **23/23**, production build PASS, ba dịch vụ staging cùng mã `21432553d8f101ac08c09d332fe47246acb7f6f8`, public verifier **17/17**, trình duyệt xác thực mở được dữ liệu đơn vị thật. Evidence: [P4 local](docs/evidence/p4-local-organization-ui-20260913.json), [P4 staging](docs/evidence/p4-staging-verified-20260913-2143255.json), [P4 public verifier](docs/evidence/p4-staging-public-verifier-20260913-2143255.json). P4 vẫn mở để kiểm hai danh tính, xung đột phiên bản và lưu trữ/khôi phục.
