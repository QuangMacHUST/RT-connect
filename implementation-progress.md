...
- **Next exact step:** close the remaining P8 gates (queue/metrics contract, failure/retry evidence and any RTDOSE/3D scope explicitly retained in `plan.md`) before starting P9.
