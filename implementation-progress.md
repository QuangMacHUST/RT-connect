...
- Sau khi rà soát trải nghiệm thực tế, trang QA máy đã được tinh giản ở commit `3a990889ec57d321b4c8862aa705ea7e4ba18c2d`: toàn bộ nhãn hiển thị là tiếng Việt, không còn hiện mã bài/tệp, mã kiểm tra tệp hoặc trạng thái kỹ thuật thô; loại bài kiểm tra và chu kỳ dùng nhãn thân thiện nhưng vẫn gửi đúng giá trị nội bộ. Luồng kiểm tra tệp và phân tích liều cũng đã được Việt hóa. Kiểm thử giao diện đạt **27/27**, lint/typecheck/build PASS; sau khi đồng bộ API, web và tiến trình nền staging, public verifier đạt **16/16** với cùng commit và schema `20260911_0020`. Đây là sửa lỗi trải nghiệm của lát cắt P4, không đóng P4; kiểm thử hai danh tính thật và bộ chọn/lịch sử trên staging vẫn còn mở.
