...
> lần đồng bộ kỹ thuật này. Revision hiện hành dùng `specification.md` v1.20,
> `technical-specification.md` v1.19 và `plan.md` v4.10; contract mới làm rõ dashboard
