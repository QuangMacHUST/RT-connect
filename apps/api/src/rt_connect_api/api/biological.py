...
def _tools() -> list[BiologicalToolResponse]:
    return [
        ...
        BiologicalToolResponse(
            ...
            status="AVAILABLE",
            available=True,
            description="Scenario nhiều course, recovery, sensitivity và cumulative scalar.",
        ),
        BiologicalToolResponse(
            tool_key="FRACTION_COMPENSATION",
            label="Bù fraction",
            route="/app/biological/fraction-compensation",
            phase="P15",
            status="AVAILABLE",
            available=True,
            description="So sánh lịch bù fraction, giữ nguyên prefix đã thực hiện.",
        ),
        BiologicalToolResponse(
            ...
            status="AVAILABLE",
            available=True,
            description="Dose limit, protocol điều trị và reference versioned theo context.",
        ),
        BiologicalToolResponse(
            ...
            status="AVAILABLE",
            available=True,
            description="Tra cứu, import preview, clone, publish và snapshot nguồn độc lập.",
        ),
    ]
