...
def test_database_readiness_requires_the_expected_alembic_revision(tmp_path) -> None:
    ...
    with engine.begin() as connection:
        ...
        connection.execute(
            text("INSERT INTO alembic_version (version_num) VALUES ('20260908_0012')")
        )
    engine.dispose()
...
def test_database_readiness_rejects_a_schema_revision_mismatch(tmp_path) -> None:
    ...
    assert reason == (
            "Database schema revision is 20260907_0007; expected 20260908_0012"
    )
